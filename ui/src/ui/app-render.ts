...
const UPDATE_BANNER_DISMISS_KEY = "stableclaw:control-ui:update-banner-dismissed:v1";
                ...
                ${navCollapsed
                  ...
                  : html`
                      ...
                      <span class="sidebar-brand__copy">
                        ...
                        <span class="sidebar-brand__title">StableClaw</span>
                      </span>
                    `}
              </div>
              <button
                        ...
                        ${group.label === "settings"
                          ? html`
                            <a
                              ...
                              href="${state.basePath || ""}/config?onboarding=1"
                              title="${t("nav.configWizard")}"
                              @click=${(event: MouseEvent) => {
                                event.preventDefault();
                                state.setTab("config");
                                // Trigger onboarding mode after navigation
                            ...
                            >
                              ...
                              ${!navCollapsed
                                ? html`
                                  <span class="nav-item__text">${t("nav.configWizard")}</span>
                                `
                                : nothing}
                            </a>
                          `
            ...
            <div class="sidebar-shell__footer">
              <div class="sidebar-utility-group">
                <a
                  ...
                  href="https://github.com/ctz168/stableclaw"
