...
export const A2UI_PATH = "/__stableclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__stableclaw__/canvas";

export const CANVAS_WS_PATH = "/__stableclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.stableclawCanvasA2UIAction.postMessage(...)
  // - Android: window.stableclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["stableclawCanvasA2UIAction"];
  ...
  globalThis.StableClaw = globalThis.StableClaw ?? {};
  globalThis.StableClaw.postMessage = postToNode;
  globalThis.StableClaw.sendUserAction = sendUserAction;
  globalThis.stableclawPostMessage = postToNode;
  globalThis.stableclawSendUserAction = sendUserAction;
