...
homepage: https://docs.stableclaw.ai/automation/hooks#my-hook
metadata:
...
2. Restart gateway: `pkill -9 -f 'stableclaw.*gateway' && pnpm stableclaw gateway`
3. Enable the hook: `stableclaw hooks enable my-hook`
4. Trigger the event (e.g., send `/new` command)
5. Check gateway logs for hook execution

## Documentation

Full documentation: https://docs.stableclaw.ai/automation/hooks
