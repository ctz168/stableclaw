...
describe("plugin install path warnings", () => {
  ...
  it("detects stale custom plugin install paths", async () => {
    ...
    expect(
      ...
      'Reinstall with "openclaw plugins install @stableclaw/matrix".',
  ...
  it("applies custom command formatting in warning messages", () => {
    expect(
      ...
      'Reinstall with "<openclaw plugins install @stableclaw/matrix>" when you want to return to the standard Matrix plugin.',
