...
const MISSING_EXTENSIONS_ERROR =
  'package.json missing openclaw.extensions; update the plugin package to include openclaw.extensions (for example ["./dist/index.js"]). See https://docs.stableclaw.ai/help/troubleshooting#plugin-install-fails-with-missing-openclaw-extensions';
