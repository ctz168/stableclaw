...
function buildDocsSection(params: { docsPath?: string; isMinimal: boolean; readToolName: string }) {
  ...
  return [
    ...
    "Mirror: https://docs.stableclaw.ai",
...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    ...safetySection,
    "## StableClaw CLI Quick Reference",
    "StableClaw is controlled via subcommands. Do not invent commands.",
    "To manage the Gateway daemon service (start/stop/restart):",
    "- stableclaw gateway status",
    "- stableclaw gateway start",
    "- stableclaw gateway stop",
    "- stableclaw gateway restart",
    "If unsure, ask the user to run `stableclaw help` (or `stableclaw gateway --help`) and paste the output.",
    "",
    ...skillsSection,
    ...memorySection,
    // Skip self-update for subagent/none modes
    hasGateway && !isMinimal ? "## StableClaw Self-Update" : "",
    hasGateway && !isMinimal
      ? [
          ...
          "After restart, StableClaw pings the last active session automatically.",
        ].join("\n")
      : "",
    hasGateway && !isMinimal ? "" : "",
    "",
