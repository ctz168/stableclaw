...
${formatHelpExamples([
  ...
  [
    'stableclaw agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'stableclaw agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['stableclaw agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'stableclaw agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
    "Send reply to a different channel/target.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.stableclaw.ai/cli/agent")}`,
    )
    .action(async (opts) => {
