...
COPY --from=runtime-assets --chown=node:node /app/stableclaw.mjs .
...
RUN ln -sf /app/stableclaw.mjs /usr/local/bin/stableclaw \
 && chmod 755 /app/stableclaw.mjs
...
CMD ["node", "stableclaw.mjs", "gateway", "--allow-unconfigured"]
