...
import { n as formatXHighModelHint, u as normalizeThinkLevel } from "./thinking.shared-D6IkoLJU.js";
import { g as resolveDefaultModelForAgent, i as buildModelAliasIndex, v as resolveModelRefFromString } from "./model-selection-w1RJdjfl.js";
import { T as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-Do__tq1E.js";
import { r as logVerbose } from "./globals-CDtV0ht8.js";
import { r as normalizeStringEntries, t as normalizeAtHashSlug } from "./string-normalization-Ddc4JXRe.js";
import { a as resolveAgentDir, f as resolveAgentSkillsFilter, i as resolveAgentConfig, n as listAgentEntries, p as resolveAgentWorkspaceDir, v as resolveSessionAgentId } from "./agent-scope-rWWUivuC.js";
...
import { _ as CHAT_CHANNEL_ORDER } from "./chat-meta-wVbKo1sw.js";
import { n as getActivePluginChannelRegistryVersion } from "./runtime-B8hqEtu6.js";
...
import { d as normalizeMessageChannel, f as resolveGatewayMessageChannel, o as isInternalMessageChannel, r as isDeliverableMessageChannel } from "./message-channel-bEWdw4ul.js";
import { C as resolveGroupSessionKey, b as deriveSessionMetaPatch, d as updateSessionStore, i as loadSessionStore } from "./store-B1hpZkjb.js";
import { t as normalizeChatType } from "./chat-type-DXjGtE-S.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./registry-CuFNdbH5.js";
import "./plugins-w6xUzHby.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-BbO0A-No.js";
import { a as resolveSessionTranscriptPath, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-xpks599B.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-DAzqpvqD.js";
import { a as resolveSessionResetType, i as resolveSessionResetPolicy, n as evaluateSessionFreshness, o as resolveThreadFlag, r as resolveChannelResetConfig, t as resolveAndPersistSessionFile } from "./session-file-BlyRlh9I.js";
import { n as resolveSessionKey } from "./session-key-BtB-2e_x.js";
import { a as normalizeDeliveryContext, n as deliveryContextKey, o as normalizeSessionDeliveryFields, t as deliveryContextFromSession } from "./delivery-context-CoAL-jTI.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-C9GhdBtf.js";
import { t as normalizeConversationText } from "./conversation-id-DCTwJCZF.js";
import { r as getSessionBindingService } from "./session-binding-service-D7bUc7mS.js";
import { n as createInternalHookEvent, p as triggerInternalHook } from "./internal-hooks-C3ziA7w_.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-C2f9Klbt.js";
import { i as generateSecureToken } from "./secure-random-Diy9rj1m.js";
import { i as getQueueSize, t as clearCommandLane } from "./command-queue-B42AiLXM.js";
import { f as clearBootstrapSnapshotOnSessionRollover, m as isReasoningTagProvider, n as resolveAgentTimeoutMs, o as disposeSessionMcpRuntime, t as collectTextContentBlocks } from "./content-blocks-kAsQDkQT.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-0f1lDMAl.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CyzUwuKH.js";
import { i as supportsXHighThinking } from "./thinking-Dga2zdtd.js";
import { r as enqueueSystemEvent } from "./system-events-5SDw3lix.js";
import { f as fireAndForgetHook, n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-CzwFvq_c.js";
import { t as buildOutboundSessionContext } from "./session-context-DbS6R7x0.js";
import { C as resolveFastModeState, t as resolveQueueSettings } from "./queue-CHs9L-yF.js";
import { t as normalizeGroupActivation } from "./group-activation-ClEb7qwj.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-D6eAR8dr.js";
import { t as hasControlCommand } from "./command-detection-C_9T2LYJ.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-CaZhrM-F.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-CacimZtw.js";
import { t as finalizeInboundContext } from "./inbound-context-Cxvd3JHZ.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-CrC9AdBL.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-BKYgZd-C.js";
import { n as parseInlineDirectives, t as isDirectiveOnly } from "./directive-handling.parse-DZBOx2eu.js";
import { t as resolveCommandAuthorization } from "./command-auth-BAkZv3cP.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-DfUTr0Tk.js";
import { t as buildCommandContext } from "./commands-context-DwBXiDQJ.js";
import { t as extractExplicitGroupId } from "./group-id-DQZw3Z1X.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DSPn_wrW.js";
import { n as resolveContextTokens, t as createModelSelectionState } from "./model-selection-GzoItsYh.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-6ySmEvs6.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-DcWuZeY0.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-CsZRYj6l.js";
import { n as buildSessionStartHookPayload, r as drainFormattedSystemEvents, t as buildSessionEndHookPayload } from "./session-hooks-C2Yle2Dl.js";
import { n as resolveTypingMode } from "./typing-mode-BRBlaMKz.js";
import { i as resolveConversationBindingContextFromMessage, o as resolveEffectiveResetTargetSessionKey } from "./conversation-binding-input-oO3WqpK6.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-Djw-kPwI.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-BWYC_0_S.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-BDYf06Qy.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-CcKqKtUg.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-B7d8Dmf9.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-C4oYEh5-.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-DkxYMWWj.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-DY_dUeVW.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-Cd_TZ9fE.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-Cd_TZ9fE.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		skillFilter
	}) : [];
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createOpenClawTools } = await import("./openclaw-tools.runtime-D1l7rOkl.js");
	...
	if (!isAbortRequestText(command.rawBodyNormalized) && sessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-ChqwE3Q0.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-AHVJBuVJ.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-AHVJBuVJ.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-toYu0-Mf.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-c5dK8bh4.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-DsUsCcHK.js");
	return agentRunnerRuntimePromise;
}
function loadRouteReplyRuntime() {
	routeReplyRuntimePromise ??= import("./route-reply.runtime-CWPjWZC0.js");
	return routeReplyRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-CQP1uuCO.js");
	return sessionUpdatesRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./store.runtime-toYu0-Mf.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-aMtRoRL4.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-CbcV1Utl.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-B01E_0Wu.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-CR6PXbQ8.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-Cr_Pthp4.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-CKcN8Q1a.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-CHGftDbd.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-CCM7z8b-.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-BPNGu1fH.js");
