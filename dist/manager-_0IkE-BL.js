...
import { T as truncateUtf16Safe, v as resolveUserPath } from "./utils-CN_F_3Qg.js";
...
import { r as listMemoryEmbeddingProviders, t as getMemoryEmbeddingProvider } from "./memory-embedding-providers-BOMS0u3X.js";
import { n as getProviderEnvVars } from "./provider-env-vars-4Bon7Y2X.js";
import { i as getMemoryMultimodalExtensions, r as classifyMemoryMultimodalPath, t as buildCaseInsensitiveExtensionGlob } from "./multimodal-DoXQtvBl.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DpAYXyjc.js";
import { t as extractKeywords } from "./query-expansion-85HlYbKD.js";
import { l as createOllamaEmbeddingProvider, t as DEFAULT_OLLAMA_EMBEDDING_MODEL } from "./ollama-ClfwP-an.js";
import { _ as estimateUtf8Bytes, a as ensureDir, c as listMemoryFiles, d as remapChunkLines, f as runWithConcurrency, g as estimateStructuredEmbeddingInputBytes, h as hasNonTextEmbeddingParts, i as cosineSimilarity, l as normalizeExtraMemoryPaths, n as buildMultimodalChunkForIndexing, o as hashText, p as isFileMissingError, r as chunkMarkdown, t as buildFileEntry, u as parseEmbedding } from "./internal-CawGE0vD.js";
import { r as readMemoryFile } from "./backend-config-CaYtHzs0.js";
import { a as runGeminiEmbeddingBatches, c as DEFAULT_VOYAGE_EMBEDDING_MODEL, d as createOpenAiEmbeddingProvider, f as DEFAULT_MISTRAL_EMBEDDING_MODEL, g as createGeminiEmbeddingProvider, h as buildGeminiEmbeddingRequest, i as runOpenAiEmbeddingBatches, l as createVoyageEmbeddingProvider, m as DEFAULT_GEMINI_EMBEDDING_MODEL, n as runVoyageEmbeddingBatches, o as DEFAULT_LOCAL_MODEL, p as createMistralEmbeddingProvider, r as OPENAI_BATCH_ENDPOINT, s as createLocalEmbeddingProvider, t as enforceEmbeddingMaxInputTokens, u as DEFAULT_OPENAI_EMBEDDING_MODEL } from "./memory-core-host-engine-embeddings-CFGw6JpT.js";
import "./memory-core-host-engine-foundation-C0gIiflS.js";
import { c as buildSessionEntry, l as listSessionFilesForAgent, u as sessionPathForFile } from "./memory-core-host-engine-qmd-m1kb7CI9.js";
import { n as loadSqliteVecExtension, r as ensureMemoryIndexSchema, t as requireNodeSqlite } from "./memory-core-host-engine-storage-DpOnoTvw.js";
import "./provider-env-vars-CJ65vHA9.js";
