...
import { n as resolveGlobalSingleton, t as resolveGlobalMap } from "./global-singleton-54zT3rCn.js";
...
function buildPluginBindingUnavailableText(binding) {
	return `The bound plugin ${resolvePluginBindingDisplayName(binding)} is not currently loaded. Routing this message to StableClaw instead.${buildDetachHintSuffix(binding.detachHint)}`;
}
