...
import { u as resolveGatewayProfileSuffix } from "./constants-Bq55qi82.js";
...
function resolveGatewayStateDir(env) {
	...
	const suffix = resolveGatewayProfileSuffix(env.STABLECLAW_PROFILE || env.OPENCLAW_PROFILE);
	return path.join(home, `.stableclaw${suffix}`);
}
//#endregion
