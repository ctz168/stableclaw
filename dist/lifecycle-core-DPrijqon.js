...
import { d as resolveIsNixMode } from "./paths-GWMNxnBn.js";
...
import { d as trimToUndefined, n as isGatewaySecretRefUnavailableError, o as createGatewayCredentialPlan, t as GatewaySecretRefUnavailableError } from "./credentials-BGPs1gIX.js";
import { t as isWSL } from "./wsl-ytdRZp54.js";
import { i as startGatewayService, t as describeGatewayServiceRestart } from "./service-2O78fADl.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-B2HBHMpF.js";
import { i as filterContainerGenericHints, m as createDaemonActionContext, p as buildDaemonServiceSnapshot } from "./shared-6u4-kP5J.js";
import { a as checkTokenDrift, n as renderSystemdUnavailableHints } from "./systemd-hints-DkRlAuPR.js";
...
async function runServiceStop(params) {
	...
	if (params.serviceNoun === "Gateway") await clearMdnsCache();
	let stopped = false;
	try {
