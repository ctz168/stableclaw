...
function resolveVersionFromRuntimeSources(params) {
	return firstNonEmpty(...params.preference === "env-first" ? [params.env["STABLECLAW_VERSION"], params.runtimeVersion] : [params.runtimeVersion, params.env["STABLECLAW_VERSION"]], params.env["STABLECLAW_SERVICE_VERSION"], params.env["npm_package_version"]) ?? params.fallback;
}
...
const VERSION = resolveBinaryVersion({
	...
	injectedVersion: typeof __STABLECLAW_VERSION__ === "string" ? __STABLECLAW_VERSION__ : void 0,
