...
import { r as loadAuthProfileStore } from "./store-DQJZr0Yf.js";
import "./auth-profiles-BnMrVe53.js";
import { _ as normalizeAccountId } from "./session-key-Do__tq1E.js";
import { t as danger } from "./globals-CDtV0ht8.js";
...
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-0yWIq2cW.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-COHnQbWX.js";
import { r as createMessageActionDiscoveryContext, s as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-CPTCAl8K.js";
...
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-Ct7gfsmU.js";
import { n as formatTimeAgo } from "./format-relative-CYrRyrT7.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-Bv3zNxO-.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-CwR2AkIk.js";
import { t as createClackPrompter } from "./clack-prompter-ByJgKHdE.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-CExWlunM.js";
import { t as parseLogLine } from "./parse-log-line-DeaRUZID.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-DEhPxgGH.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-BkU8zmv7.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-445y8c5g.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-DpBs6EbM.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-DVrUbqWA.js"), import("./onboard-channels-B92ZJdl1.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-DSp9AQsL.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-DSp9AQsL.js");
			const prompter = createClackPrompter();
