...
import { h as loadWorkspaceBootstrapFiles } from "./workspace-D5P9nuJd.js";
import { l as loadEnabledBundleMcpConfig } from "./loader-DsZDoLQ6.js";
import { O as resolveProviderReasoningOutputModeWithPlugin } from "./provider-runtime-YHMKDzAl.js";
import { a as redactSensitiveUrlLikeString, i as redactSensitiveUrl } from "./redact-sensitive-url-CAJSZ_7g.js";
import { n as normalizeConfiguredMcpServers } from "./mcp-config-ps5bhVPe.js";
...
const MAX_AGENT_TIMEOUT_SECONDS = 600;
...
function resolveAgentTimeoutMs(opts) {
	...
	const maxAgentTimeoutMs = MAX_AGENT_TIMEOUT_SECONDS * 1e3;
	const clampToAgentCeiling = (valueMs) => Math.min(clampTimeoutMs(valueMs), maxAgentTimeoutMs);
	...
	if (overrideSeconds !== void 0) {
		...
		return clampToAgentCeiling(overrideSeconds * 1e3);
	}
	return defaultMs;
}
//#endregion
