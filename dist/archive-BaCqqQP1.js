import { c as isPathInside, s as isNotFoundPathError, t as sameFileIdentity } from "./file-identity-DPm-6kp0.js";
import { o as openFileWithinRoot, r as copyFileWithinRoot, s as openWritableFileWithinRoot, t as SafeOpenError } from "./fs-safe-BQ59ttjX.js";
import { n as resolveSafeBaseDir } from "./path-safety-2mfHCe0n.js";
...
async function withStagedArchiveDestination(params) {
	const stagingDir = await fs.mkdtemp(path.join(params.destinationRealDir, ".stableclaw-archive-"));
	try {
