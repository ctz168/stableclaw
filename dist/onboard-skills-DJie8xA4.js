...
import { p as resolveNodeManagerOptions } from "./onboard-helpers-BTKcMkph.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DxA1DugQ.js";
import { t as installSkill } from "./skills-install-D1Ee1nJx.js";
...
async function setupSkills(cfg, workspaceDir, runtime, prompter) {
	...
	if (installable.length > 0) {
		...
		for (const name of selected) {
			...
			runtime.log("Docs: https://docs.stableclaw.ai/skills");
		}
	}
