...
import { u as isRecord, v as resolveUserPath } from "./utils-CN_F_3Qg.js";
import { i as openBoundaryFileSync, n as matchBoundaryFileOpenFailure } from "./boundary-file-read-DB4ibbUg.js";
import { c as buildPluginLoaderAliasMap, d as resolvePluginRuntimeModulePath, l as buildPluginLoaderJitiOptions, m as shouldPreferNativeJiti } from "./chat-meta-wVbKo1sw.js";
import { i as getActivePluginRegistryKey, r as getActivePluginRegistry, u as recordImportedPluginId, v as setActivePluginRegistry, y as createEmptyPluginRegistry } from "./runtime-B8hqEtu6.js";
import { i as kindsEqual, n as defaultSlotIdForKey, r as hasKind } from "./slots-Dq-2eIRb.js";
import { a as normalizePluginsConfig, l as resolveMemorySlotDecision, o as resolveEffectiveEnableState, s as resolveEffectivePluginActivationState, t as applyTestPluginDefaults } from "./config-state-DfIk9ME6.js";
import { a as safeStatSync, c as CURSOR_BUNDLE_MANIFEST_RELATIVE_PATH, d as mergeBundlePathLists, f as normalizeBundlePathList, o as CLAUDE_BUNDLE_MANIFEST_RELATIVE_PATH, r as isPathInside, s as CODEX_BUNDLE_MANIFEST_RELATIVE_PATH } from "./min-host-version-CIhgRq0c.js";
import { a as resolvePluginCacheInputs, i as discoverOpenClawPlugins, n as loadPluginManifestRegistry } from "./manifest-registry-Kx5Z2lJL.js";
import { t as validateJsonSchemaValue } from "./schema-validator-DofqBvJi.js";
import { t as applyMergePatch } from "./merge-patch-CtvE2OP0.js";
import { t as isChannelConfigured } from "./channel-configured-B6WgvouH.js";
import { t as buildPluginApi } from "./api-builder-uuKvRs_O.js";
import { a as isPluginHookName, d as validatePluginCommandDefinition, f as clearPluginInteractiveHandlers, g as clearPluginCommands, h as registerPluginInteractiveHandler, l as registerPluginCommand, o as isPromptInjectionHookName, s as stripPromptMutationFieldsFromLegacyHookResult } from "./types-DVJVELY7.js";
import { i as initializeGlobalHookRunner } from "./hook-runner-global-C9GhdBtf.js";
import { a as registerMemoryEmbeddingProvider, i as listRegisteredMemoryEmbeddingProviders, n as getRegisteredMemoryEmbeddingProvider, o as restoreRegisteredMemoryEmbeddingProviders } from "./memory-embedding-providers-BOMS0u3X.js";
import { a as getMemoryRuntime, c as registerMemoryPromptSection, d as restoreMemoryPluginState, i as getMemoryPromptSectionBuilder, l as registerMemoryRuntime, n as clearMemoryPluginState, r as getMemoryFlushPlanResolver, s as registerMemoryFlushPlanResolver } from "./memory-state-DDJh6L4-.js";
import { o as recordPluginError$1 } from "./plugin-error-handler-DWUTf_UF.js";
import { n as registerContextEngineForOwner } from "./registry-ByjnKj3u.js";
import { f as registerInternalHook } from "./internal-hooks-C3ziA7w_.js";
import { a as normalizePluginHttpPath, t as findOverlappingPluginHttpRoute } from "./http-route-overlap-C8lbolN5.js";
...
let persistentWarningCache = null;
function getPersistentWarningCache(env = process.env) {
	if (persistentWarningCache !== null) return persistentWarningCache;
	try {
		const stateDir = env.OPENCLAW_STATE_DIR?.trim() || (process.platform === "win32" ? path.join(env.USERPROFILE || env.HOME || "", ".openclaw") : path.join(env.HOME || "", ".openclaw"));
		...
		} else persistentWarningCache = /* @__PURE__ */ new Set();
	} catch {
		persistentWarningCache = /* @__PURE__ */ new Set();
	}
	return persistentWarningCache;
}
function savePersistentWarningCache(cache, env = process.env) {
	try {
		const stateDir = env.OPENCLAW_STATE_DIR?.trim() || (process.platform === "win32" ? path.join(env.USERPROFILE || env.HOME || "", ".openclaw") : path.join(env.HOME || "", ".openclaw"));
		if (!fsSync.existsSync(stateDir)) fsSync.mkdirSync(stateDir, { recursive: true });
		const cachePath = path.join(stateDir, PERSISTENT_WARNING_CACHE_FILE);
		fsSync.writeFileSync(cachePath, JSON.stringify([...cache], null, 2), "utf-8");
	} catch {}
}
...
function maybeThrowOnPluginLoadError(registry, throwOnLoadError) {
	if (throwOnLoadError !== true) return;
...
function warnWhenAllowlistIsOpen(params) {
	...
	if (cache.has(params.warningCacheKey)) return;
...
//#endregion
export { getPluginRuntimeGatewayRequestScope as a, inspectBundleMcpRuntimeSupport as c, loadEnabledBundleConfig as d, readBundleJsonObject as f, resolveRuntimePluginRegistry as i, loadEnabledBundleMcpConfig as l, loadOpenClawPlugins as n, withPluginRuntimeGatewayRequestScope as o, resolveCompatibleRuntimePluginRegistry as r, extractMcpServerMap as s, loadOpenClawPluginCliRegistry as t, inspectBundleServerRuntimeSupport as u };
