...
import { i as getChildLogger, y as normalizeLogLevel } from "./logger-MWEZrHUL.js";
...
import { l as escapeRegExp } from "./utils-CN_F_3Qg.js";
...
import { T as parseAgentSessionKey, c as normalizeAgentId, h as toAgentStoreSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-Do__tq1E.js";
import { a as shouldLogVerbose } from "./globals-CDtV0ht8.js";
import { a as resolveAgentDir, i as resolveAgentConfig, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-rWWUivuC.js";
import { a as logWarn } from "./logger-DdGvppaE.js";
import { r as runCommandWithTimeout } from "./exec-BO6vYjRf.js";
import { d as ensureAgentWorkspace, i as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-D5P9nuJd.js";
import { c as loadConfig, x as writeConfigFile } from "./io-8kNEV_ou.js";
import { c as buildPluginLoaderAliasMap, l as buildPluginLoaderJitiOptions, m as shouldPreferNativeJiti } from "./chat-meta-wVbKo1sw.js";
import "./config-D9-X_LMC.js";
import { d as updateSessionStore, i as loadSessionStore, l as saveSessionStore, o as readSessionUpdatedAt, s as recordSessionMetaFromInbound, u as updateLastRoute } from "./store-B1hpZkjb.js";
import { t as getChannelPlugin } from "./registry-CuFNdbH5.js";
import "./plugins-w6xUzHby.js";
import { n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-BbO0A-No.js";
...
import { i as resolveSessionResetPolicy, n as evaluateSessionFreshness } from "./session-file-BlyRlh9I.js";
import { a as normalizeDeliveryContext } from "./delivery-context-CoAL-jTI.js";
import { n as onSessionTranscriptUpdate } from "./transcript-events-Dc7U5QmQ.js";
import "./logging-CAfgK7sj.js";
import { i as resolveHumanDelayConfig, n as resolveAgentIdentity, r as resolveEffectiveMessagesConfig } from "./identity-DvwF6Yix.js";
import { t as HEARTBEAT_TOKEN } from "./tokens-C2f9Klbt.js";
import { a as stripHeartbeatToken, i as resolveHeartbeatPrompt$1, r as isHeartbeatContentEffectivelyEmpty } from "./heartbeat-C_TrErgd.js";
import { $t as createManagedTaskFlow, Bt as listTaskFlowsForOwner, Ht as cancelTaskById, It as getFlowTaskSummary, J as getTaskByIdForOwner, K as findLatestTaskForRelatedSessionKeyForOwner, Lt as runTaskInFlowForOwner, Mt as cancelFlowByIdForOwner, Rt as findLatestTaskFlowForOwner, Vt as resolveTaskFlowForLookupTokenForOwner, X as resolveTaskForLookupTokenForOwner, Xn as onAgentEvent, Y as listTasksForRelatedSessionKeyForOwner, cn as resumeFlow, ln as setFlowWaiting, nn as finishFlow, on as requestFlowCancel, qt as listTasksForFlowId, tn as failFlow, zt as getTaskFlowByIdForOwner } from "./pi-embedded-B8eJYvw3.js";
import { i as getQueueSize, u as CommandLane } from "./command-queue-B42AiLXM.js";
import { f as clearBootstrapSnapshotOnSessionRollover, n as resolveAgentTimeoutMs } from "./content-blocks-kAsQDkQT.js";
import { a as getImageMetadata, l as resizeToJpeg } from "./image-ops-BJKjhMAu.js";
import { i as resolveUserTimezone } from "./date-time-DRQ0-oaw.js";
import { m as mediaKindFromMime, t as detectMime } from "./mime-DkaKoCVP.js";
import { t as deliverOutboundPayloads } from "./deliver-CRZitKsS.js";
import { C as setHeartbeatWakeHandler, S as requestHeartbeatNow, T as resolveHeartbeatReasonKind, x as areHeartbeatsEnabled } from "./model-runtime-Bnss57nB.js";
import { l as resolveSystemEventDeliveryContext, o as peekSystemEventEntries, r as enqueueSystemEvent } from "./system-events-5SDw3lix.js";
import { p as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-CRYI4jIB.js";
import { a as chunkText, c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, o as chunkTextWithMode, r as chunkMarkdownText, s as resolveChunkMode, t as chunkByNewline } from "./chunk-CW-a7Cfh.js";
...
import { n as resolveHeartbeatSenderContext, t as resolveHeartbeatDeliveryTarget } from "./targets-BXWLPbLc.js";
import { l as saveMediaBuffer } from "./store-BOF6oB0g.js";
import { n as fetchRemoteMedia } from "./fetch-DD0-6ZFw.js";
import { t as loadWebMedia } from "./web-media-D7cxUvsg.js";
import { a as createLazyRuntimeSurface, n as createLazyRuntimeMethodBinder, r as createLazyRuntimeModule, t as createLazyRuntimeMethod } from "./lazy-runtime-C6LCAM-L.js";
import { i as resolveAgentRoute, t as buildAgentSessionKey } from "./resolve-route-EE8E7OAF.js";
import { n as summarizeTaskRecords } from "./task-registry.summary-SoFiECCc.js";
import { y as shouldHandleTextCommands } from "./commands-registry-UVwExw9k.js";
import { i as runWebSearch, n as listWebSearchProviders } from "./runtime-C6g97pFu.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-G9GcSyph.js";
import { t as appendCronStyleCurrentTimeLine } from "./current-time--aIDbABZ.js";
import { i as shouldComputeCommandAuthorized, r as isControlCommandMessage, t as hasControlCommand } from "./command-detection-C_9T2LYJ.js";
import { c as dispatchReplyFromConfig, i as withReplyDispatcher, o as createReplyDispatcherWithTyping } from "./dispatch-BSM98GaS.js";
import { t as finalizeInboundContext } from "./inbound-context-Cxvd3JHZ.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope, t as formatAgentEnvelope } from "./envelope-CrC9AdBL.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-CI7l3R36.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes, r as matchesMentionPatterns } from "./mentions-BKYgZd-C.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-CjPFZ9Sp.js";
import { n as shouldAckReaction, t as removeAckReactionAfterReply } from "./ack-reactions-fcKs7CQ_.js";
...
import { c as recordChannelActivity, n as emitHeartbeatEvent, o as resolveIndicatorType, s as getChannelActivity, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CHMO4pmJ.js";
import { t as convertMarkdownTables } from "./tables-D6qL6k4d.js";
import { t as buildPairingReply } from "./pairing-messages-DxLpe0GE.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-B171dUVa.js";
import { a as resolveThreadBindingIdleTimeoutMs, c as resolveThreadBindingMaxAgeMs, d as unbindThreadBindingsBySessionKey, l as setThreadBindingIdleTimeoutBySessionKey, o as resolveThreadBindingInactivityExpiresAt, r as getThreadBindingManager, s as resolveThreadBindingMaxAgeExpiresAt, u as setThreadBindingMaxAgeBySessionKey } from "./discord-thread-bindings-D4nQKhiF.js";
import { u as discordMessageActions } from "./discord-runtime-surface-CNY2JeRx.js";
import { n as resolvePluginRuntimeModulePath, r as resolvePluginRuntimeRecord, t as loadPluginBoundaryModuleWithJiti } from "./runtime-plugin-boundary-BzC61_Tn.js";
import { a as probeSignal, d as signalMessageActions, i as monitorSignalProvider, l as sendMessageSignal } from "./signal-surface-Bm_s4qNw.js";
import "./signal-CBOtC21l.js";
import { i as isVoiceCompatibleAudio } from "./audio-DZWA6M9B.js";
...
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-8akeXBiN.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("./runtime-embedded-pi.runtime-CBOlEGU0.js"));
...
const bindDiscordRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-discord-ops.runtime-TyG8PLSt.js"), ({ runtimeDiscordOps }) => runtimeDiscordOps));
...
const rl = () => loadRuntimeLineModule().runtimeLine;
function createRuntimeLine() {
	return {
		listLineAccountIds: (...args) => rl().listLineAccountIds(...args),
		resolveDefaultLineAccountId: (...args) => rl().resolveDefaultLineAccountId(...args),
		resolveLineAccount: (...args) => rl().resolveLineAccount(...args),
		normalizeAccountId: (...args) => rl().normalizeAccountId(...args),
		probeLineBot: (...args) => rl().probeLineBot(...args),
		sendMessageLine: (...args) => rl().sendMessageLine(...args),
		pushMessageLine: (...args) => rl().pushMessageLine(...args),
		pushMessagesLine: (...args) => rl().pushMessagesLine(...args),
		pushFlexMessage: (...args) => rl().pushFlexMessage(...args),
		pushTemplateMessage: (...args) => rl().pushTemplateMessage(...args),
		pushLocationMessage: (...args) => rl().pushLocationMessage(...args),
		pushTextMessageWithQuickReplies: (...args) => rl().pushTextMessageWithQuickReplies(...args),
		createQuickReplyItems: (...args) => rl().createQuickReplyItems(...args),
		buildTemplateMessageFromPayload: (...args) => rl().buildTemplateMessageFromPayload(...args),
		monitorLineProvider: (...args) => rl().monitorLineProvider(...args)
	};
}
//#endregion
...
const bindSlackRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-slack-ops.runtime-Dg8PilrZ.js"), ({ runtimeSlackOps }) => runtimeSlackOps));
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("./runtime-tts.runtime-D8muS3kN.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-media-understanding.runtime-fmq9CEZz.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime-Dc-22nt_.js"));
