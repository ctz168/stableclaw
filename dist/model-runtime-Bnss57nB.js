...
import { o as resolveWindowsCommandShim, s as spawnWithFallback } from "./exec-BO6vYjRf.js";
import "./host-env-security-SlXI58bc.js";
import { t as killProcessTree } from "./kill-tree-CUPpLbeq.js";
import { r as generateSecureInt } from "./secure-random-Diy9rj1m.js";
import { r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-DAOB2dK4.js";
import { r as enqueueSystemEvent } from "./system-events-5SDw3lix.js";
import { D as clampWithDefault, E as chunkString, j as readEnvInt, w as buildDockerExecArgs } from "./sandbox-DyOJU5Yj.js";
...
function createProcessSupervisor() {
	...
	const spawn = async (input) => {
		...
		try {
			...
			const { warnProcessSupervisorSpawnFailure } = await import("./supervisor-log.runtime-ULoueC6r.js");
