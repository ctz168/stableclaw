...
import { l as escapeRegExp, t as CONFIG_DIR, v as resolveUserPath } from "./utils-CN_F_3Qg.js";
...
import { o as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-BQ59ttjX.js";
import { a as ensureMediaDir, l as saveMediaBuffer } from "./store-BOF6oB0g.js";
import "./temp-path-JU2kkd64.js";
import { n as deriveDefaultBrowserCdpPortRange, r as deriveDefaultBrowserControlPort } from "./port-defaults-Dajs4Obu.js";
import { t as parseBooleanValue } from "./boolean-BEhDlAk_.js";
import "./logging-core-ynfg7W60.js";
import { a as ensureGatewayStartupAuth } from "./nodes.helpers-DeBC9u_C.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BNMzHn2m.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-BNMzHn2m.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-BNMzHn2m.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
