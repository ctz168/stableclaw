...
import { t as require_src } from "./src-DYFQvohm.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-DYykTvn5.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-D6E2_i8_.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-DMerPTLg.js";
import { l as toRatio, n as decodeString } from "./Util-DhmHPY8a.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-DNQp4skg.js";
import { t as APEv2Parser } from "./APEv2Parser-C47rh4Eg.js";
import { r as hasID3v1Header } from "./ID3v1Parser-D2Ih6zzD.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-CCp4LzGu.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-eoGBmotd.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BPnua6Va.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-C1t3hGM9.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DHom0uj4.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BrGD03yX.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-CXyHxpb5.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CiAni_z3.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DCi3ogJ4.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-BkhLr_oK.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-gSUE5kSQ.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-BxIi2oO_.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DMLB2Zd5.js")).WaveParser;
	}
};
//#endregion
...
//#endregion
//#region node_modules/.pnpm/music-metadata@11.12.3/node_modules/music-metadata/lib/index.js
/**
