...
import { g as resolveHomeDir } from "./utils-CN_F_3Qg.js";
import { t as formatDocsLink } from "./links-D7o22Ygt.js";
import { r as theme } from "./theme-wBMZmJzz.js";
import { _ as resolveStateDir, h as resolveOAuthDir, i as isNixMode, o as resolveConfigPath, u as resolveGatewayPort } from "./paths-GWMNxnBn.js";
...
import { f as resolveControlUiLinks, i as formatControlUiSshHint } from "./onboard-helpers-BTKcMkph.js";
...
import { a as removePath, i as listAgentSessionDirs, o as removeStateAndLinkedPaths, r as buildCleanupPlan, s as removeWorkspaceDirs } from "./backup-create-CLbGtJ4M.js";
...
async function dashboardCommand(runtime = defaultRuntime, options = {}) {
	...
	if (resolvedToken.unresolvedRefReason) {
		...
		runtime.log("Set OPENCLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `stableclaw dashboard`.");
	}
	...
	if (opened) runtime.log("Opened in your browser. Keep that tab to control StableClaw.");
...
async function removeMacApp(runtime, dryRun) {
	...
	await removePath("/Applications/StableClaw.app", runtime, {
		dryRun,
		label: "/Applications/StableClaw.app"
	});
}
function logBackupRecommendation(runtime) {
	runtime.log(`Recommended first: ${formatCliCommand("stableclaw backup create")}`);
}
		...
		const selection = await multiselectStyled({
			...
			options: [
				...
				},
				{
					value: "app",
					label: "macOS app",
					hint: "/Applications/StableClaw.app"
				}
			],
			initialValues: [
				"service",
