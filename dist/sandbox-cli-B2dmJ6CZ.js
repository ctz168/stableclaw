...
import { T as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-Do__tq1E.js";
import { i as resolveAgentConfig } from "./agent-scope-rWWUivuC.js";
import { c as loadConfig } from "./io-8kNEV_ou.js";
import { a as normalizeAnyChannelId } from "./registry-mVzzlPf7.js";
import "./config-D9-X_LMC.js";
import { t as formatCliCommand } from "./command-format-CX1xXtgB.js";
import { t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-bEWdw4ul.js";
import { i as loadSessionStore } from "./store-B1hpZkjb.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey } from "./main-session-BbO0A-No.js";
...
import { i as removeSandboxContainer, n as listSandboxContainers, r as removeSandboxBrowserContainer, t as listSandboxBrowsers } from "./sandbox-DyOJU5Yj.js";
...
const SANDBOX_DOCS_URL = "https://docs.stableclaw.ai/sandbox";
...
async function sandboxExplainCommand(opts, runtime) {
	...
	lines.push("");
	lines.push(`${key("Docs:")} ${formatDocsLink("/sandbox", "docs.stableclaw.ai/sandbox")}`);
