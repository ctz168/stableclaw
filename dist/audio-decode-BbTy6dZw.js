...
//#region node_modules/.pnpm/audio-type@2.4.0/node_modules/audio-type/audio-type.js
...
//#endregion
//#region node_modules/.pnpm/audio-buffer@5.0.0/node_modules/audio-buffer/index.js
/**
* AudioBuffer class
*/
...
//#endregion
//#region node_modules/.pnpm/audio-decode@2.2.3/node_modules/audio-decode/audio-decode.js
/**
...
const decoders = {
	async oga(buf) {
		...
		if (!decoder) {
			let { OggVorbisDecoder } = await import("./ogg-vorbis-D42tmcYd.js");
	...
	async flac(buf) {
		...
		if (!decoder) {
			const { FLACDecoder } = await import("./flac-Di3GB9iT.js");
	...
	async opus(buf) {
		...
		if (!decoder) {
			const { OggOpusDecoder } = await import("./ogg-opus-decoder-pwWV10rb.js");
	...
	async wav(buf) {
		...
		if (!decode) {
			let module = await import("./node-wav-D4psHJiF.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	...
	async qoa(buf) {
		...
		if (!decode) decoders.qoa.decode = decode = (await import("./qoa-format-48SQ90sV.js")).decode;
		return buf && createBuffer(await decode(buf));
	}
};
