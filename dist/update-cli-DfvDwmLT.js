...
import { m as pathExists } from "./utils-CN_F_3Qg.js";
...
import { n as DEFAULT_GATEWAY_PORT, u as resolveGatewayPort } from "./paths-GWMNxnBn.js";
import { r as runCommandWithTimeout } from "./exec-BO6vYjRf.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-F1SOdmJ0.js";
import { f as readConfigFileSnapshot } from "./io-8kNEV_ou.js";
import { l as asResolvedSourceConfig, u as asRuntimeConfig } from "./validation-IqV6B-0y.js";
import { a as parseSemver, i as nodeVersionSatisfiesEngine } from "./runtime-guard-78ESz4Qy.js";
import { r as replaceConfigFile } from "./config-D9-X_LMC.js";
import { n as resolveCliName, t as replaceCliName } from "./cli-name-C3PA6Rhs.js";
import { t as formatCliCommand } from "./command-format-CX1xXtgB.js";
import { f as resolveGatewaySystemdServiceName, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-Bq55qi82.js";
import { n as stylePromptMessage } from "./prompt-style-DekFM6h7.js";
import { r as resolveGatewayService } from "./service-2O78fADl.js";
import { n as quoteCmdScriptArg } from "./cmd-argv-BbyQhzAC.js";
import { r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-BLCPZV1F.js";
import { n as formatConfigIssueLines } from "./issue-format-DLZczJ0U.js";
import { a as terminateStaleGatewayPids, i as renderRestartDiagnostics, s as waitForGatewayHealthyRestart } from "./status-C8FIGjbG.js";
import { r as formatDurationPrecise } from "./format-duration-DqcpDYkZ.js";
import { o as trimLogTail } from "./restart-sentinel-B3EigRIb.js";
import { t as formatHelpExamples } from "./help-format-5ems77mC.js";
import { r as installCompletion } from "./completion-cli-DNjZ7wPK.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-DYoEFm5V.js";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-BEIt4HsB.js";
import { n as doctorCommand, t as selectStyled } from "./prompt-select-styled-CWGMtpIi.js";
import { i as fetchNpmTagVersion, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmPackageTargetStatus, t as checkUpdateStatus } from "./update-check-C4B4aSvJ.js";
import { _ as readPackageName, a as runGatewayUpdate, c as collectInstalledGlobalPackageErrors, d as detectGlobalInstallManagerForRoot, f as globalInstallArgs, g as normalizePackageTagInput, h as resolveGlobalPackageRoot, l as createGlobalInstallEnv, m as resolveGlobalInstallSpec, o as canResolveRegistryVersionForPackageTarget, p as resolveExpectedInstalledVersionFromSpec, s as cleanupGlobalRenameDirs, u as detectGlobalInstallManagerByPresence, v as readPackageVersion } from "./server-startup-matrix-migration-BlziAKsS.js";
import { c as resolveEffectiveUpdateChannel, i as formatUpdateChannelLabel, l as resolveUpdateChannelDisplay, r as channelToNpmTag, s as normalizeUpdateChannel } from "./update-channels-Cqiboku6.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-B-v79o4s.js";
...
function resolveDefaultGitDir() {
	...
	if (home.startsWith("/")) return path.posix.join(home, "stableclaw");
...
async function updateStatusCommand(opts) {
	...
	defaultRuntime.log(theme.heading("StableClaw update status"));
	defaultRuntime.log("");
...
async function runPackageInstallUpdate(params) {
	...
	const packageName = (pkgRoot ? await readPackageName(pkgRoot) : await readPackageName(params.root)) ?? "stableclaw";
...
async function updateCommand(opts) {
	...
	if (result.status === "skipped") {
		...
		if (result.reason === "not-git-install") {
			defaultRuntime.log(theme.warn(`Skipped: this StableClaw install isn't a git checkout, and the package manager couldn't be detected. Update via your package manager, then run \`${replaceCliName(formatCliCommand("openclaw doctor"), CLI_NAME)}\` and \`${replaceCliName(formatCliCommand("openclaw gateway restart"), CLI_NAME)}\`.`));
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/update", "docs.stableclaw.ai/cli/update")}`;
	}).action(async (opts) => {
		try {
			await updateCommand({
	...
	])}\n\n${theme.heading("Notes:")}\n${theme.muted("- Shows current update channel (stable/beta/dev) and source")}\n${theme.muted("- Includes git tag/branch/SHA for source checkouts")}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/update", "docs.stableclaw.ai/cli/update")}`).action(async (opts, command) => {
		try {
