export declare const GENERATED_BASE_CONFIG_SCHEMA: {
    ...
    readonly uiHints: {
        ...
        readonly "channels.defaults.contextVisibility": {
            readonly label: "Default Context Visibility";
            readonly help: "Default supplemental context visibility for fetched quote/thread/history content: \"all\" (keep all context), \"allowlist\" (only allowlisted senders), or \"allowlist_quote\" (allowlist + keep explicit quotes).";
            readonly tags: ["network", "channels"];
        };
