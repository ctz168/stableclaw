 ...
 */
export declare const SUBAGENT_PROGRESS_STREAM: "progress";
export declare const SUBAGENT_PROGRESS_PHASE_SPAWNED: "spawned";
export declare const SUBAGENT_PROGRESS_PHASE_STARTED: "started";
export declare const SUBAGENT_PROGRESS_PHASE_TOOL_CALL: "tool_call";
export declare const SUBAGENT_PROGRESS_PHASE_TOOL_RESULT: "tool_result";
export declare const SUBAGENT_PROGRESS_PHASE_THINKING: "thinking";
export declare const SUBAGENT_PROGRESS_PHASE_TEXT: "text";
export declare const SUBAGENT_PROGRESS_PHASE_ERROR: "error";
export declare const SUBAGENT_PROGRESS_PHASE_COMPLETED: "completed";
export declare const SUBAGENT_PROGRESS_PHASE_KILLED: "killed";
export declare const SUBAGENT_PROGRESS_PHASE_TIMEOUT: "timeout";
export declare const SUBAGENT_PROGRESS_PHASE_STEER: "steer";
export type SubagentProgressPhase = typeof SUBAGENT_PROGRESS_PHASE_SPAWNED | typeof SUBAGENT_PROGRESS_PHASE_STARTED | typeof SUBAGENT_PROGRESS_PHASE_TOOL_CALL | typeof SUBAGENT_PROGRESS_PHASE_TOOL_RESULT | typeof SUBAGENT_PROGRESS_PHASE_THINKING | typeof SUBAGENT_PROGRESS_PHASE_TEXT | typeof SUBAGENT_PROGRESS_PHASE_ERROR | typeof SUBAGENT_PROGRESS_PHASE_COMPLETED | typeof SUBAGENT_PROGRESS_PHASE_KILLED | typeof SUBAGENT_PROGRESS_PHASE_TIMEOUT | typeof SUBAGENT_PROGRESS_PHASE_STEER | (string & {});
 ...
 */
export declare function emitSubagentProgress(event: {
    runId: string;
    phase: SubagentProgressPhase;
    message: string;
    detail?: Record<string, unknown>;
 ...
 */
export declare function onSubagentProgress(handler: (event: SubagentProgressEvent) => void): () => void;
/**
 * Subscribe to progress events for a specific run.
 * Returns an unsubscribe function.
 */
export declare function onSubagentRunProgress(runId: string, handler: (event: SubagentProgressEvent) => void): () => void;
/**
 ...
 * ```
 */
export declare function createSubagentProgressTracker(): {
 ...
 */
export type SubagentRecoveryHandler = (recoveryId: string, userInput: string) => Promise<void>;
/**
 ...
 */
export declare function onSubagentFailure(handler: SubagentFailureHandler): () => void;
/**
 ...
 */
export declare function setRecoveryHandler(handler: SubagentRecoveryHandler): () => void;
/**
 ...
 */
export declare function submitRecoveryInput(recoveryId: string, userInput: string): Promise<boolean>;
/**
 ...
 */
export declare function getPendingRecoveryRequest(recoveryId: string): SubagentFailureRecoveryRequest | undefined;
/**
 * Get all pending recovery requests.
 * Useful for UI initialization to show existing failed tasks.
 */
export declare function getAllPendingRecoveryRequests(): SubagentFailureRecoveryRequest[];
/**
 * Clear a pending recovery request after it has been handled.
 */
export declare function clearPendingRecoveryRequest(recoveryId: string): void;
/**
 ...
 */
export declare function emitSubagentFailureRecovery(params: {
    runId: string;
    sessionKey?: string;
    parentSessionKey?: string;
