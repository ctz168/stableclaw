...
export declare const MATRIX_LEGACY_CRYPTO_INSPECTOR_UNAVAILABLE_MESSAGE = "Legacy Matrix encrypted state was detected, but the Matrix plugin helper is unavailable. Install or repair @stableclaw/matrix so OpenClaw can inspect the old rust crypto store before upgrading.";
