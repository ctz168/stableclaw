import { a as normalizeHostOverrideEnvVarKey } from "./host-env-security-SlXI58bc.js";
import { $ as unwrapDispatchWrappersForResolution, J as unwrapKnownShellMultiplexerInvocation, K as hasEnvManipulationBeforeShellWrapper, W as extractShellWrapperCommand, X as POWERSHELL_INLINE_COMMAND_FLAGS, Y as POSIX_INLINE_COMMAND_FLAGS, Z as resolveInlineCommandMatch, tt as normalizeExecutableToken } from "./validation-IqV6B-0y.js";
...
function fallbackHostName() {
	return os.hostname().trim().replace(/\.local$/i, "") || "stableclaw";
}
