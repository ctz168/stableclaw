import { g as resolveHomeDir, u as isRecord } from "./utils-CN_F_3Qg.js";
import { t as CONFIG_PATH } from "./paths-GWMNxnBn.js";
import { f as readConfigFileSnapshot } from "./io-8kNEV_ou.js";
import { o as OpenClawSchema } from "./validation-IqV6B-0y.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-8Ysu8e-f.js");
