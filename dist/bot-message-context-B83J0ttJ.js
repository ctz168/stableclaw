import { d as resolveThreadSessionKeys, f as sanitizeAgentId, r as buildAgentMainSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-Do__tq1E.js";
...
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-EE8E7OAF.js";
import { p as normalizeCommandBody } from "./commands-registry-UVwExw9k.js";
import { t as resolveChannelGroupPolicy } from "./group-policy-G9GcSyph.js";
...
import { t as firstDefined } from "./allow-from-Bqq4nO4W.js";
...
import { n as DEFAULT_EMOJIS } from "./channel-feedback-CAaJ5Tc6.js";
...
async function resolveStickerVisionSupport(params) {
	try {
		const { resolveStickerVisionSupportRuntime } = await import("./sticker-vision.runtime-ByUbnudq.js");
...
async function resolveTelegramInboundBody(params) {
	...
	if (isGroup && requireMention && hasAudio && !hasUserText && mentionRegexes.length > 0 && !disableAudioPreflight && senderAllowedForAudioPreflight) try {
		const { transcribeFirstAudio } = await import("./media-understanding.runtime-pqAPJLHj.js");
...
async function buildTelegramInboundContextPayload(params) {
	...
	const sessionRuntime = await import("./bot-message-context.session.runtime-CF065vwi.js");
...
async function loadTelegramMessageContextRuntime() {
	telegramMessageContextRuntimePromise ??= import("./bot-message-context.runtime-DTwo3MHz.js");
