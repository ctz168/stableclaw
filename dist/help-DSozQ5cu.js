import { A as hasFlag, M as hasRootVersionAlias, _ as ALLOWED_LOG_LEVELS, b as tryParseLogLevel } from "./logger-MWEZrHUL.js";
...
import { n as resolveCommitHash } from "./git-commit-ChiOoWyK.js";
import { i as hasEmittedCliBanner, r as formatCliBannerLine } from "./banner-CIvut-6N.js";
import { n as getCoreCliCommandsWithSubcommands } from "./core-command-descriptors-CjWzjGCJ.js";
import { t as getSubCliCommandsWithSubcommands } from "./subcli-descriptors-Bo8_4eK1.js";
...
function configureProgramHelp(program, ctx) {
	...
	if (hasFlag(process.argv, "-V") || hasFlag(process.argv, "--version") || hasRootVersionAlias(process.argv)) {
		...
		console.log(commit ? `StableClaw ${ctx.programVersion} (${commit})` : `StableClaw ${ctx.programVersion}`);
		process.exit(0);
	}
	...
	program.addHelpText("afterAll", ({ command }) => {
		...
		const docs = formatDocsLink("/cli", "docs.stableclaw.ai/cli");
