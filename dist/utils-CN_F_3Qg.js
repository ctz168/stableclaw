import { n as resolveEffectiveHomeDir, o as resolveRequiredHomeDir, r as resolveHomeRelativePath } from "./home-dir-n9onX5PG.js";
...
function resolveHomeDisplayPrefix() {
	...
	if (!home) return;
	if (process.env.STABLECLAW_HOME?.trim() || process.env.OPENCLAW_HOME?.trim()) return {
		home,
		prefix: "$STABLECLAW_HOME"
	};
	return {
		home,
		prefix: "~"
