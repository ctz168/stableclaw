...
import { r as STATE_DIR } from "./paths-GWMNxnBn.js";
import { r as logVerbose } from "./globals-CDtV0ht8.js";
import { c as loadConfig, p as readConfigFileSnapshotForWrite, x as writeConfigFile } from "./io-8kNEV_ou.js";
import { n as saveJsonFile, t as loadJsonFile } from "./json-file-5xJqyXrK.js";
import { l as resolveStorePath } from "./paths-xpks599B.js";
import "./json-store-FUgu1pyj.js";
import { a as getImageMetadata } from "./image-ops-BJKjhMAu.js";
import { s as resolveApiKeyForProvider } from "./model-auth-BwrO4e9-.js";
import { o as isGifMedia, s as kindFromMime } from "./mime-DkaKoCVP.js";
import { n as normalizePollInput } from "./polls-CMmT0F_y.js";
import { t as loadWebMedia } from "./web-media-D7cxUvsg.js";
import { d as AUTO_IMAGE_KEY_PROVIDERS, h as DEFAULT_IMAGE_MODELS } from "./resolve-RhoDstpn.js";
import { a as resolveAutoImageModel } from "./runner-nFhtX_Ej.js";
...
import { r as isTelegramVoiceCompatibleAudio } from "./audio-DZWA6M9B.js";
...
import { t as isDiagnosticFlagEnabled } from "./diagnostic-flags-CWBer16s.js";
import { r as createTelegramRetryRunner } from "./retry-policy-Cby_CfHV.js";
import "./ssrf-runtime-C5GmhLZD.js";
import "./media-runtime-kLH8iJyW.js";
import { n as describeImageFileWithModel } from "./media-understanding-runtime-BPMdkdpO.js";
...
import "./retry-runtime-dQoxxyMJ.js";
import { s as resolveTelegramAccount } from "./accounts-BBGvfk1i.js";
import { i as parseTelegramTarget, n as normalizeTelegramChatId, r as normalizeTelegramLookupTarget } from "./targets-BNp2m2rT.js";
import { n as resolveTelegramFetch } from "./fetch-C1R9XOH_.js";
import { P as normalizeTelegramReplyToMessageId, a as splitTelegramHtmlChunks, i as renderTelegramHtmlText, m as buildTypingThreadParams, p as buildTelegramThreadParams, s as withTelegramApiErrorLogging } from "./format-rkxJqiuo.js";
...
function readPersistedSentMessages(filePath) {
	if (!fsSync.existsSync(filePath)) return createSentMessageStore();
	try {
...
function persistSentMessages() {
	...
	fsSync.writeFileSync(tempPath, JSON.stringify(serialized), "utf-8");
...
//#endregion
export { wasSentByBot as C, isTelegramPollingNetworkError as D, isTelegramClientRejection as E, tagTelegramNetworkError as O, recordSentMessage as S, isSafeToRetrySendError as T, sendPollTelegram as _, getCachedSticker as a, unpinMessageTelegram as b, createForumTopicTelegram as c, editMessageReplyMarkupTelegram as d, editMessageTelegram as f, sendMessageTelegram as g, renameForumTopicTelegram as h, getCacheStats as i, splitTelegramCaption as k, deleteMessageTelegram as l, reactMessageTelegram as m, describeStickerImage as n, searchStickers as o, pinMessageTelegram as p, getAllCachedStickers as r, buildInlineKeyboard as s, cacheSticker as t, editForumTopicTelegram as u, sendStickerTelegram as v, isRecoverableTelegramNetworkError as w, resolveTelegramVoiceSend as x, sendTypingTelegram as y };
