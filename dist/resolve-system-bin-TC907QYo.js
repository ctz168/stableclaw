import { n as getWindowsProgramFilesRoots, t as getWindowsInstallRoots } from "./windows-install-roots-XI3CvO9O.js";
...
function defaultIsExecutable(filePath) {
	try {
		if (process.platform === "win32") fsSync.accessSync(filePath, fsSync.constants.R_OK);
		else fsSync.accessSync(filePath, fsSync.constants.X_OK);
		return true;
	} catch {
		return false;
	}
