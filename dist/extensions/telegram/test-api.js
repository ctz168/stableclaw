...
import { r as listTelegramAccountIds, s as resolveTelegramAccount } from "../../accounts-BBGvfk1i.js";
import { i as telegramOutbound } from "../../status-issues-CN_HT8rK.js";
import { n as resolveTelegramFetch } from "../../fetch-C1R9XOH_.js";
import { _ as sendPollTelegram, g as sendMessageTelegram } from "../../sticker-cache-C9crI4BY.js";
import { i as handleTelegramAction, n as telegramMessageActionRuntime } from "../../monitor-qtsIc667.js";
import { n as setTelegramRuntime, t as telegramPlugin } from "../../channel-CrH-WDcm.js";
import { r as resetTelegramThreadBindingsForTests } from "../../thread-bindings-1QHxxeE-.js";
...
async function loadBuildTelegramMessageContext() {
	...
	if (!buildTelegramMessageContextLoader) ({buildTelegramMessageContext: buildTelegramMessageContextLoader} = await import("../../bot-message-context-CM7VuzZF.js"));
	return buildTelegramMessageContextLoader;
}
async function loadVitestModule() {
	vitestModuleLoader ??= import("../../dist-DCuLVVvN.js");
