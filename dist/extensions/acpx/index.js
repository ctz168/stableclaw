...
import { An as AcpRuntimeError, _n as registerAcpRuntimeBackend, yn as unregisterAcpRuntimeBackend } from "../../pi-embedded-B8eJYvw3.js";
import { a as resolveWindowsSpawnProgramCandidate, n as materializeWindowsSpawnProgram, t as applyWindowsSpawnProgramPolicy } from "../../windows-spawn-DKvkg_66.js";
import "../../core-CKHoDVyA.js";
import "../../extension-shared-hULUC8pE.js";
import { t as zod_exports } from "../../zod-CzZTZ85h.js";
import "../../runtime-api-3wpY-fsw.js";
	...
	return {
		...
		async start(ctx) {
			...
			try {
				...
				throw new Error(`acpx runtime backend probe failed: ${lastFailureMessage ?? "backend remained unhealthy after setup"}`);
			} catch (err) {
				if (currentRevision !== lifecycleRevision) return;
