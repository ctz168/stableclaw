...
import { f as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-DfkVOICL.js";
...
function isExplicitMatrixInstallRequest(request) {
	...
	if ([request.rawSpec.trim(), request.normalizedSpec.trim()].includes("@stableclaw/matrix")) return true;
