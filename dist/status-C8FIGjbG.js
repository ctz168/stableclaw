...
import { S as sleep, x as shortenHomePath } from "./utils-CN_F_3Qg.js";
import { n as isRich, r as theme, t as colorize } from "./theme-wBMZmJzz.js";
import { _ as resolveStateDir, o as resolveConfigPath, u as resolveGatewayPort } from "./paths-GWMNxnBn.js";
import { i as createConfigIO } from "./io-8kNEV_ou.js";
import "./config-D9-X_LMC.js";
import { t as formatCliCommand } from "./command-format-CX1xXtgB.js";
import { f as resolveGatewaySystemdServiceName, l as resolveGatewayLaunchAgentLabel } from "./constants-Bq55qi82.js";
import { d as trimToUndefined, n as isGatewaySecretRefUnavailableError } from "./credentials-BGPs1gIX.js";
import { i as parseStrictPositiveInteger } from "./parse-finite-number-CzdLC_gQ.js";
import { d as loadGatewayTlsRuntime } from "./call-DRbdwIRZ.js";
import { r as isWSLEnv } from "./wsl-ytdRZp54.js";
import { r as resolveBestEffortGatewayBindHostForDisplay, t as inspectBestEffortPrimaryTailnetIPv4 } from "./network-discovery-display-h8MqTMCI.js";
...
import { a as inspectPortUsage, o as classifyPortListener, s as formatPortDiagnostics } from "./ports-ZA1n2It7.js";
import { t as killProcessTree } from "./kill-tree-CUPpLbeq.js";
import { p as classifySystemdUnavailableDetail } from "./systemd-B2HBHMpF.js";
import { a as filterDaemonEnv, c as pickProbeHostForBind, d as resolveRuntimeStatusColor, f as safeDaemonEnv, o as normalizeListenerAddress, s as parsePortFromArgs, t as createCliStatusTextStyles, u as renderRuntimeHints } from "./shared-6u4-kP5J.js";
import { d as resolveDaemonContainerContext, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-DkRlAuPR.js";
...
import { i as resolveGatewayProbeAuthWithSecretInputs } from "./probe-auth-DChgV-5Y.js";
...
async function probeGatewayStatus(opts) {
	try {
		const result = await withProgress({
			...
			if (opts.requireRpc) {
				const { callGateway } = await import("./call-Xd20887z.js");
				await callGateway({
					url: opts.url,
					token: opts.token,
			...
			const { probeGateway } = await import("./probe-kfBMuOWF.js");
...
function printDaemonStatus(status, opts) {
	...
	defaultRuntime.log(`${label("Troubleshooting:")} https://docs.stableclaw.ai/troubleshooting`);
}
//#endregion
