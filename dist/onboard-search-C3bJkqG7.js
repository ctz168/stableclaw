import { a as hasConfiguredSecretInput, l as normalizeSecretInputString, t as DEFAULT_SECRET_PROVIDER_ALIAS } from "./types.secrets-BpcqHPAv.js";
import { t as enablePluginInConfig } from "./enable-BgSxsKp_.js";
import { a as resolveBundledWebSearchPluginId, i as listBundledWebSearchProviders, n as sortWebSearchProviders } from "./web-search-providers.shared-DE2avTwD.js";
import { t as resolvePluginWebSearchProviders } from "./web-search-providers.runtime-DATRGy5E.js";
import { n as sortFlowContributionsByLabel } from "./types-D9ku6_y5.js";
...
async function runSearchSetupFlow(config, runtime, prompter, opts) {
	...
	if (!needsCredential) {
		await prompter.note([
			...
			"StableClaw will enable the plugin and use it as your web_search provider.",
			`Docs: ${entry.docsUrl ?? "https://docs.stableclaw.ai/tools/web"}`
		].join("\n"), "Web search");
