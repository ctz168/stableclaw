...
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-C4lsZ_HR.js";
import { a as signDevicePayload, n as loadOrCreateDeviceIdentity } from "./device-identity-Doxo0HJx.js";
import { O as sniffMimeFromBase64 } from "./pi-embedded-B8eJYvw3.js";
import { o as estimateBase64DecodedBytes } from "./tool-images-BDUvc_pd.js";
import { i as deleteMediaBuffer, l as saveMediaBuffer } from "./store-BOF6oB0g.js";
...
const GATEWAY_DEVICE_ID_HEADER = "x-stableclaw-gateway-device-id";
const GATEWAY_SIGNATURE_HEADER = "x-stableclaw-gateway-signature";
const GATEWAY_SIGNED_AT_HEADER = "x-stableclaw-gateway-signed-at-ms";
...
//#endregion
export { loadApnsRegistration as a, resolveApnsAuthConfigFromEnv as c, shouldClearStoredApnsRegistration as d, resolveApnsRelayConfigFromEnv as f, clearApnsRegistrationIfCurrent as i, sendApnsAlert as l, MediaOffloadError as n, normalizeApnsEnvironment as o, parseMessageWithAttachments as r, registerApnsRegistration as s, normalizeRpcAttachmentsToChatAttachments as t, sendApnsBackgroundWake as u };
