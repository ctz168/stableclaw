...
import { p as extractAssistantText } from "./minimax-vlm-Dze7LYMY.js";
...
import { r as createReplyReferencePlanner } from "./reply-runtime-D93EYf6l.js";
import "./media-runtime-kLH8iJyW.js";
import "./text-runtime-CFGBmTOj.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./agent-runtime-Css0zKcC.js";
import { o as Routes, s as StickerFormatType } from "./v10-CwUVAgnz.js";
import { o as mergeAbortSignals } from "./timeouts-B5Z4bCIF.js";
...
async function resolveDiscordThreadStarter(params) {
	...
	try {
		...
		const payload = {
			...
			authorTag: starter.author?.username && starter.author?.discriminator ? starter.author.discriminator !== "0" ? `${starter.author.username}#${starter.author.discriminator}` : starter.author.username : void 0,
			memberRoleIds: (() => {
				const roles = starter.member?.roles;
