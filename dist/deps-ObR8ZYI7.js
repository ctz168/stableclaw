...
function createDefaultDeps() {
	return {
		whatsapp: createLazySender("whatsapp", () => import("./whatsapp-DqlsEgV2.js")),
		telegram: createLazySender("telegram", () => import("./telegram-L7QW9lVL.js")),
		discord: createLazySender("discord", () => import("./discord-DBaVtiDb.js")),
		slack: createLazySender("slack", () => import("./slack-DGcKpztJ.js")),
		signal: createLazySender("signal", () => import("./signal-PlHqGQkP.js")),
		imessage: createLazySender("imessage", () => import("./imessage-Cf_UyICm.js"))
	};
}
