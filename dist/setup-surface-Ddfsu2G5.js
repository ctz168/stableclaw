...
import { O as promptAccountId, t as addWildcardAllowFrom, v as mergeAllowFromEntries } from "./setup-wizard-helpers-4lMI_ec6.js";
...
import { s as resolveMatrixAccountConfig, t as resolveMatrixConfigFieldPath } from "./config-paths-B5BXqXfz.js";
...
import { n as resolveMatrixEnvAuthReadiness } from "./setup-core-DMKS6yPx.js";
import { t as updateMatrixAccountConfig } from "./config-update-C48BoanL.js";
import { c as validateMatrixHomeserverUrl, s as resolveValidatedMatrixHomeserverUrl } from "./config-Ctft1ZDl.js";
import "./client-Dr5bRGDg.js";
import { n as listMatrixDirectoryGroupsLive, t as resolveMatrixTargets } from "./resolve-targets-DdSZ7dTs.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-qI1Lhs3Z.js";
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-BGB2qILu.js");
