import { i as clampInt, v as resolveUserPath } from "./utils-CN_F_3Qg.js";
import { d as normalizeUsageDisplay, p as resolveResponseUsageMode, s as normalizeFastMode } from "./thinking.shared-D6IkoLJU.js";
import { _ as normalizeAccountId, v as normalizeOptionalAccountId } from "./session-key-Do__tq1E.js";
...
import { A as setConfigValueAtPath, D as unsetConfigOverride, E as setConfigOverride, O as getConfigValueAtPath, T as resetConfigOverrides, f as readConfigFileSnapshot, j as unsetConfigValueAtPath, k as parseConfigPath, w as getConfigOverrides, x as writeConfigFile } from "./io-8kNEV_ou.js";
import { a as validateConfigObjectWithPlugins } from "./validation-IqV6B-0y.js";
import { o as normalizeChannelId } from "./registry-mVzzlPf7.js";
import { t as clearPluginManifestRegistryCache } from "./manifest-registry-Kx5Z2lJL.js";
...
import { _ as GATEWAY_CLIENT_NAMES, d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES, o as isInternalMessageChannel } from "./message-channel-bEWdw4ul.js";
import { d as updateSessionStore, i as loadSessionStore } from "./store-B1hpZkjb.js";
import { t as getChannelPlugin } from "./registry-CuFNdbH5.js";
import { n as resolveChannelApprovalCapability } from "./plugins-w6xUzHby.js";
import "./sessions-DukJH1Gz.js";
import { i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-xpks599B.js";
import { a as resolveFreshSessionTotalTokens } from "./types-DAzqpvqD.js";
import { un as ErrorCodes } from "./method-scopes-B6e_KuRU.js";
import { r as callGateway } from "./call-DRbdwIRZ.js";
import { r as isRestartEnabled, t as isCommandFlagEnabled } from "./commands-BxWe27p0.js";
...
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-MzecpVik.js";
import { B as resolveAcpThreadSessionDetailLines, Dr as stripToolMessages, Mr as createExecTool, P as spawnSubagentDirect, R as resolveAcpSessionCwd, S as stripToolResultDetails, _t as steerControlledSubagentRun, ar as sortSubagentRuns, cr as formatTaskStatusTitle, ct as listTasksForAgentIdForStatus, dt as killAllControlledSubagentRuns, ft as killControlledSubagentRun, g as compactEmbeddedPiSession, gt as sendControlledSubagentMessage, lr as sanitizeTaskStatusText, lt as listTasksForSessionKeyForStatus, mt as listControlledSubagentRuns, nr as formatRunLabel, nt as formatContextUsageShort, or as buildTaskStatusSnapshot, pn as readAcpSessionEntry, q as findTaskByRunIdForOwner, rt as formatTokenCount, s as EmbeddedBlockChunker, sr as formatTaskStatusDetail, ut as buildSubagentList, yt as countPendingDescendantRuns } from "./pi-embedded-B8eJYvw3.js";
import { t as diag } from "./diagnostic-DLLxcEb3.js";
...
import "./thinking-Dga2zdtd.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-DnhseQ_3.js";
import { r as getApiKeyForModel } from "./model-auth-BwrO4e9-.js";
import { t as ensureOpenClawModelsJson } from "./models-config-BZosuR7o.js";
import { n as setPluginEnabledInConfig } from "./enable-BgSxsKp_.js";
import { i as unsetConfiguredMcpServer, r as setConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-ps5bhVPe.js";
import { O as getFinishedSession, k as getSession } from "./model-runtime-Bnss57nB.js";
import { r as enqueueSystemEvent } from "./system-events-5SDw3lix.js";
import "./sandbox-DyOJU5Yj.js";
import { t as formatDurationCompact } from "./format-duration-DqcpDYkZ.js";
import { a as getActiveEmbeddedRunSnapshot, f as waitForEmbeddedPiRunEnd, o as isEmbeddedPiRunActive, t as abortEmbeddedPiRun, v as scheduleGatewaySigusr1Restart, x as triggerStableClawRestart } from "./runs-CDodmdPt.js";
import { C as resolveFastModeState, i as clearSessionQueues } from "./queue-CHs9L-yF.js";
import { n as parseActivationCommand } from "./group-activation-ClEb7qwj.js";
...
import { n as formatTokenCount$1, r as formatUsd } from "./usage-format-C52ZQlyn.js";
import { p as normalizeCommandBody } from "./commands-registry-UVwExw9k.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-DvHTlpJG.js";
import { c as resolveThreadBindingIdleTimeoutMsForChannel, d as resolveThreadBindingMaxAgeMsForChannel, g as formatThreadBindingDurationLabel, i as formatThreadBindingSpawnDisabledError, p as resolveThreadBindingSpawnPolicy, r as formatThreadBindingDisabledError, v as resolveThreadBindingIntroText, y as resolveThreadBindingThreadName } from "./thread-bindings-policy-Br8s4hQ6.js";
import { i as resolveModelWithRegistry } from "./anthropic-vertex-stream-0tvmS2P2.js";
import { n as createPluginRuntime } from "./runtime-BLXXQ9Tm.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-D6eAR8dr.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-BKYgZd-C.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-B171dUVa.js";
import { a as resolveArchiveKind } from "./archive-BaCqqQP1.js";
import { r as formatElevatedUnavailableMessage } from "./reply-9RCQUUFN.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DSPn_wrW.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-DcWuZeY0.js";
import { n as resolveSessionEntryForKey, r as stopSubagentsForRequester, t as formatAbortReplyText } from "./abort-CcPv8e91.js";
import { t as extractBtwQuestion } from "./btw-command-9Fbh-dXM.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-b2OP4nF4.js";
import { a as handleHelpCommand, c as handleWhoamiCommand, i as handleExportSessionCommand, n as handleCommandsListCommand, o as handleStatusCommand, r as handleContextCommand, s as handleToolsCommand } from "./commands-info-D3u2s9V0.js";
import { c as rejectUnauthorizedCommand, l as requireCommandFlagEnabled, o as buildDisabledCommandReply, r as handleModelsCommand, s as rejectNonOwnerCommand, u as requireGatewayClientScopeForInternalChannel } from "./commands-models-CCiVipS7.js";
import { S as resolveCommandSurfaceChannel, _ as resolveTelegramConversationId, a as formatLogLines, b as isTelegramSurface, c as resolveCommandSubagentController, d as resolveFocusTargetSession, f as resolveHandledPrefix, g as stopWithText, h as resolveSubagentsAction, i as buildSubagentsHelp, l as resolveDiscordChannelIdForFocus, m as resolveSubagentEntryForToken, o as formatTimestampWithAge, p as resolveRequesterSessionKey, s as loadSubagentSessionEntry, u as resolveDisplayStatus, v as isDiscordSurface, x as resolveChannelAccountId, y as isMatrixSurface } from "./targets-C-3GNl8W.js";
import { t as handleAcpCommand } from "./commands-acp-fxa3nQOa.js";
import { i as isTelegramExecApprovalClientEnabled, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-C4onrGCZ.js";
import "./api-CEFs5VTl.js";
import { n as incrementCompactionCount } from "./session-updates-ViT8vSog.js";
import { t as parseConfigValue } from "./config-value-CBX9Yhu9.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-k2eLgb0V.js";
import { s as parseClawHubPluginSpec } from "./clawhub-Bi6Jol-I.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-DQYBvGSU.js";
import { r as installPluginFromClawHub } from "./clawhub-BZmEblst.js";
import { a as buildPluginInspectReport, i as buildPluginDiagnosticsReport, o as buildPluginSnapshotReport, s as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-BFiiw38z.js";
import { a as decidePreferredClawHubFallback, f as resolveFileNpmSpecToLocalPath, i as createPluginInstallLogger, n as buildPreferredClawHubSpec } from "./plugins-command-helpers-DfkVOICL.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-BViMlGPL.js";
...
async function handleBashChatCommand(params) {
	if (!isCommandFlagEnabled(params.cfg, "bash")) return buildDisabledCommandReply({
		label: "bash",
		configKey: "bash",
		docsUrl: "https://docs.stableclaw.ai/tools/slash-commands#config"
	});
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-CIfAbzdN.js");
		killProcessTree(pid);
...
const handleRestartCommand = async (params, allowTextCommands) => {
	...
	if (process.listenerCount("SIGUSR1") > 0) {
		...
		return {
			shouldContinue: false,
			reply: { text: "⚙️ Restarting StableClaw in-process (SIGUSR1); back in a few seconds." }
		};
	}
	const restartMethod = triggerStableClawRestart();
	if (!restartMethod.ok) {
