...
import { a as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-CLFL8FLU.js";
...
import { d as createAllowlistProviderGroupPolicyWarningCollector, x as projectConfigAccountIdWarningCollector } from "./group-policy-warnings-CB9zpPaA.js";
...
import { n as createMessageToolCardSchema } from "./channel-actions-BqpLGRng.js";
import { t as chunkTextForOutbound } from "./text-chunking-CaZUUsI2.js";
import { t as zod_exports } from "./zod-CzZTZ85h.js";
import { a as createFeishuClient, c as listEnabledFeishuAccounts, d as resolveFeishuAccount, f as resolveFeishuRuntimeAccount, l as listFeishuAccountIds, s as inspectFeishuCredentials, u as resolveDefaultFeishuAccountId } from "./probe-DmRCSSru.js";
import "./runtime-api-CRxWYw1L.js";
import { n as normalizeFeishuTarget, t as looksLikeFeishuId } from "./targets-Drsgj1jq.js";
import { i as resolveFeishuGroupToolPolicy } from "./policy-jwmRe_bJ.js";
import { i as parseFeishuTargetId, n as parseFeishuConversationId, r as parseFeishuDirectConversationId, t as buildFeishuConversationId } from "./conversation-id-B6Nxce_u.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-FoKFnP9Q.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-C8ZFeP1C.js";
import { n as feishuSetupAdapter, t as feishuSetupWizard } from "./setup-surface-FfCyFLDj.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-MIP38qVz.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-B87iv8bw.js");
