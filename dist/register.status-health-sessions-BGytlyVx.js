...
import { d as updateSessionStore, g as enforceSessionDiskBudget, h as resolveMaintenanceConfig, i as loadSessionStore, m as pruneStaleEntries, p as capEntryCount } from "./store-B1hpZkjb.js";
import "./sessions-DukJH1Gz.js";
import { i as resolveSessionFilePathOptions, r as resolveSessionFilePath } from "./paths-xpks599B.js";
...
import { n as parsePositiveIntOrUndefined } from "./helpers-Bob1LTom.js";
import { r as healthCommand } from "./health-CYC7-jZ6.js";
import { a as formatSessionModelCell, c as toSessionDisplayRows, i as formatSessionKeyCell, l as resolveSessionStoreTargetsOrExit, n as formatSessionAgeCell, o as resolveSessionDisplayDefaults, r as formatSessionFlagsCell, s as resolveSessionDisplayModel, t as sessionsCommand } from "./sessions-DogCkF1c.js";
import { t as statusCommand } from "./status-l7_z6V7g.js";
import { c as reconcileTaskLookupToken, i as getInspectableTaskRegistrySummary, n as summarizeTaskAuditFindings, o as previewTaskRegistryMaintenance, r as getInspectableTaskAuditSummary, s as reconcileInspectableTasks, t as listTaskAuditFindings, u as runTaskRegistryMaintenance } from "./task-registry.audit-RPAwpl9h.js";
...
function registerStatusHealthSessionsCommands(program) {
	...
	])}`).addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/status", "docs.stableclaw.ai/cli/status")}\n`).action(async (opts) => {
