...
import { a as resolveArchiveKind, r as fileExists } from "./archive-BaCqqQP1.js";
...
async function packNpmSpecToArchive(params) {
	...
	if (res.code !== 0) {
		...
		if (/E404|is not in this registry/i.test(raw)) return {
			ok: false,
			error: `Package not found on npm: ${params.spec}. See https://docs.stableclaw.ai/tools/plugin for installable plugins.`
		};
		return {
			ok: false,
