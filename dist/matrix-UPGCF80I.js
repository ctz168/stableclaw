...
import { n as defaultSlotIdForKey } from "./slots-Dq-2eIRb.js";
import { t as formatCliCommand } from "./command-format-CX1xXtgB.js";
import { a as detectLegacyMatrixState, i as autoMigrateLegacyMatrixState, n as hasPendingMatrixMigration, o as autoPrepareLegacyMatrixCrypto, r as maybeCreateMatrixMigrationSnapshot, s as detectLegacyMatrixCrypto, t as hasActionableMatrixMigration } from "./matrix-migration-snapshot-sIK4GwxV.js";
import { r as resolveBundledPluginInstallCommandHint } from "./bundled-sources-C2WkVzZw.js";
import { a as resolvePluginInstallDir } from "./install-DQYBvGSU.js";
import { n as formatPluginInstallPathIssue, t as detectPluginInstallPathIssue } from "./plugin-install-path-warnings-CrKPbEqN.js";
...
async function uninstallPlugin(params) {
	...
	try {
		const { unloadPlugin } = await import("./plugin-hot-reload-OV8EW87o.js");
		const unloadResult = await unloadPlugin({
			pluginId,
			config
		});
		if (!unloadResult.ok) console.warn(`Plugin ${pluginId} hot-unload warning: ${unloadResult.error}`);
	} catch (error) {
