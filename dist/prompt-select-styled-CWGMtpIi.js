import { o as getResolvedLoggerSettings } from "./logger-MWEZrHUL.js";
...
import { t as isTruthyEnvValue$1 } from "./env-CK3eZNIX.js";
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-CN_F_3Qg.js";
import { c as updateAuthProfileStoreWithLock, n as ensureAuthProfileStore } from "./store-DQJZr0Yf.js";
import { r as formatAuthDoctorHint, t as resolveApiKeyForProfile } from "./auth-profiles-BnMrVe53.js";
...
import { _ as resolveHooksGmailModel, a as getModelRefStatus, h as resolveConfiguredModelRef } from "./model-selection-w1RJdjfl.js";
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-GWMNxnBn.js";
import { T as parseAgentSessionKey, _ as normalizeAccountId, g as DEFAULT_ACCOUNT_ID, v as normalizeOptionalAccountId } from "./session-key-Do__tq1E.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-rWWUivuC.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-BO6vYjRf.js";
import { n as resolveOpenClawPackageRootSync, t as resolveOpenClawPackageRoot } from "./openclaw-root-F1SOdmJ0.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-D5P9nuJd.js";
import { M as migrateLegacyConfig, f as readConfigFileSnapshot, x as writeConfigFile } from "./io-8kNEV_ou.js";
import { P as resolveCommandResolutionFromArgv, _ as listRiskyConfiguredSafeBins, f as getTrustedSafeBinDirs, h as normalizeTrustedSafeBinDirs, lt as normalizeTalkSection, ot as resolveNormalizedProviderModelMaxTokens, p as isTrustedSafeBinPath, st as LEGACY_TALK_PROVIDER_ID, yt as migrateLegacyXSearchConfig } from "./validation-IqV6B-0y.js";
import { a as mergeMissing } from "./legacy.shared-oZM32end.js";
import { C as resolveSlackNativeStreaming, S as resolveDiscordPreviewStreamMode, T as resolveTelegramPreviewStreamMode, b as formatSlackStreamingBooleanMigrationMessage, w as resolveSlackStreamingMode, y as formatSlackStreamModeMigrationMessage } from "./zod-schema.providers-core-Bmbs-R4l.js";
import { r as normalizeChatChannelId } from "./chat-meta-wVbKo1sw.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-BpcqHPAv.js";
import "./registry-mVzzlPf7.js";
import { a as normalizePluginsConfig, i as normalizePluginId, s as resolveEffectivePluginActivationState } from "./config-state-DfIk9ME6.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-Kx5Z2lJL.js";
import "./config-D9-X_LMC.js";
import { n as parseToolsBySenderTypedKey } from "./types.tools-BTQL6INB.js";
import { t as describeUnknownError } from "./shared-CK49TKED.js";
import { d as resolveProfileUnusableUntilForDisplay } from "./order-ancEfFoY.js";
import { t as repairOAuthProfileIdMismatch } from "./repair-IMBZnz-L.js";
import { t as formatCliCommand } from "./command-format-CX1xXtgB.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-Bq55qi82.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-NiQSNveu.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-BDS86twM.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DPejcJWG.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-BD7_M2AG.js";
import { d as resolveGatewayBindHost, r as isLoopbackHost } from "./net-DjzoSxQo.js";
import { u as readGatewayTokenEnv } from "./credentials-BGPs1gIX.js";
import { a as resolveGatewayAuth } from "./auth-CmL8nlqP.js";
import { i as loadSessionStore } from "./store-B1hpZkjb.js";
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-DXKlQp1z.js";
import { n as listChannelPlugins, t as getChannelPlugin } from "./registry-CuFNdbH5.js";
import "./plugins-w6xUzHby.js";
import { i as resolveMainSessionKey } from "./main-session-BbO0A-No.js";
import { i as resolveAgentSessionDirs } from "./sessions-DukJH1Gz.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-xpks599B.js";
import { r as listPotentialConfiguredChannelIds } from "./config-presence-omlqvhAQ.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-Dn1WqnYq.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-C7svKLqX.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-DRbdwIRZ.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-HlGwTZP3.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-ytdRZp54.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DekFM6h7.js";
import { a as guardCancel, d as randomToken, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-BTKcMkph.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-cp98MUhz.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-2O78fADl.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-ZA1n2It7.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-B2HBHMpF.js";
...
import { n as formatConfigIssueLines } from "./issue-format-DLZczJ0U.js";
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-BasQGOd9.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-Cxl1bFGj.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-B8dw6NVJ.js";
import { t as resolvePluginProviders } from "./providers.runtime-BzUP7TiO.js";
import { d as shouldMoveSingleAccountChannelKey } from "./setup-helpers-0yWIq2cW.js";
import { Br as resolveBootstrapContextForRun, Cr as LowercaseNonEmptyStringFieldSchema, Sr as DeliveryThreadIdFieldSchema, Tr as parseOptionalField, an as listTaskFlowRecords, c as analyzeBootstrapBudget, gr as inferLegacyName, l as buildBootstrapInjectionStats, qt as listTasksForFlowId, wr as TrimmedNonEmptyStringFieldSchema, yr as normalizeOptionalText } from "./pi-embedded-B8eJYvw3.js";
import { Y as resolveBootstrapMaxChars, Z as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-Cp6GzY8d.js";
import { d as DEFAULT_SANDBOX_IMAGE, l as DEFAULT_SANDBOX_BROWSER_IMAGE, r as resolveSandboxScope } from "./config-BbS6IxMR.js";
import { s as resolveApiKeyForProvider } from "./model-auth-BwrO4e9-.js";
import { t as migrateLegacyWebSearchConfig } from "./legacy-web-search-Bn8F2jrN.js";
import { l as loadExecApprovals } from "./exec-approvals-DAOB2dK4.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-By58XtjH.js";
import "./sandbox-DyOJU5Yj.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-Cs-6sySM.js";
...
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-CTrFghcj.js";
import { i as listRouteBindings } from "./bindings-AuReyzvX.js";
import { nt as readBrowserVersion, rt as resolveGoogleChromeExecutableForPlatform, tt as parseBrowserMajorVersion } from "./browser-runtime-CQoD4tu1.js";
import { r as resolveActiveMemoryBackendConfig } from "./memory-runtime-DTXpzcp1.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DpAYXyjc.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-BCrmijcz.js";
import { a as readChannelAllowFromStore } from "./pairing-store-B171dUVa.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-CmJaeeLZ.js";
...
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-4xPb-RRe.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-C2WkVzZw.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-Dti8AjRL.js";
import { i as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, n as getBuiltinMemoryEmbeddingProviderDoctorMetadata } from "./memory-core-engine-runtime-B5tL3Xda.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-CaYtHzs0.js";
import { _ as DEFAULT_GOOGLE_API_BASE_URL } from "./memory-core-host-engine-embeddings-CFGw6JpT.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-CAKcr30V.js";
import { t as checkQmdBinaryAvailability } from "./memory-core-host-engine-qmd-m1kb7CI9.js";
import "./memory-core-host-engine-storage-DpOnoTvw.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DxA1DugQ.js";
import { i as buildPluginDiagnosticsReport, r as buildPluginCompatibilityWarnings } from "./status-BFiiw38z.js";
import { t as note$1 } from "./note-y0CGIAvP.js";
import { n as resolveExecPolicyScopeSnapshot } from "./exec-approvals-effective-brrDcdJK.js";
import { r as healthCommand } from "./health-CYC7-jZ6.js";
import { n as runMatrixDoctorSequence, t as cleanStaleMatrixPluginConfig } from "./matrix-UPGCF80I.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-SlJunB75.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-CA2ADQFJ.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BgZYCErl.js";
import { t as formatHealthCheckFailure } from "./health-format-Ci9UHeCP.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-CPG3eYBu.js";
import { i as normalizeTelegramAllowFromEntry, n as isNumericTelegramUserId, r as listTelegramAccountIds, t as inspectTelegramAccount } from "./read-only-account-inspect.telegram-1-xXgIZd.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-CAFyDZ9c.js";
import { a as runGatewayUpdate, n as coerceFiniteScheduleNumber, t as runStartupMatrixMigration } from "./server-startup-matrix-migration-BlziAKsS.js";
import { n as doctorShellCompletion } from "./doctor-completion-B-v79o4s.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-445y8c5g.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-DSW3yvTD.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-BJ7RWidZ.js";
import "./doctor-state-migrations-CgeKE_R9.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-D96u1DiW.js";
...
function collectExecPolicyConflictWarnings(cfg) {
	...
	const defaultRequestedSecuritySource = "StableClaw default (full)";
	const defaultRequestedAskSource = "StableClaw default (off)";
	const maybeWarn = (params) => {
