import { M as hasRootVersionAlias } from "./logger-MWEZrHUL.js";
...
const DEFAULT_TAGLINE = "All your chats, one StableClaw.";
...
const TAGLINES = [
	...
	"You had me at 'stableclaw gateway start.'",
...
function formatCliBannerArt(options = {}) {
	...
	return LOBSTER_ASCII.map((line) => {
		if (line.includes("STABLECLAW")) return theme.muted("              ") + theme.accent("🦞") + theme.info(" STABLECLAW ") + theme.accent("🦞");
