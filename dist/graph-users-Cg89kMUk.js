...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-CNSj1bcA.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-CEHJYtGY.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createNoOpHttpPlugin() {
	...
	const { PLUGIN_METADATA_KEY } = await import("./plugin-Bc1RCw9i.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_DEPENDENCIES_METADATA_KEY } = await import("./dependency-DHBlTiU7.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_EVENTS_METADATA_KEY } = await import("./event-C3P7ByHd.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function createBotFrameworkJwtValidator(creds) {
	const { JwtValidator } = await import("./jwt-validator-Y47zhfB9.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
