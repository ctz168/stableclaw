import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-GWMNxnBn.js";
import { t as DEFAULT_AGENT_ID } from "./session-key-Do__tq1E.js";
import { _ as listRiskyConfiguredSafeBins, h as normalizeTrustedSafeBinDirs } from "./validation-IqV6B-0y.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-BpcqHPAv.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-B3GdTjId.js";
...
import { l as isPrivateNetworkAllowedByPolicy, s as isBlockedHostnameOrIp } from "./ssrf-DbpV0Zd3.js";
import { V as isInterpreterLikeAllowlistPattern, l as loadExecApprovals } from "./exec-approvals-DAOB2dK4.js";
...
import { c as resolveBrowserControlAuth, l as resolveProfile, o as redactCdpUrl, s as resolveBrowserConfig } from "./browser-config-D_OlwMzh.js";
import { n as collectEnabledInsecureOrDangerousFlags, t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-BU34EjpL.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-DcjzAZWt.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-er25LIw-.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-B_DowMHz.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-lOV1HJyU.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-Xd20887z.js"),
		import("./probe-auth-DY7jUhp7.js"),
		import("./probe-kfBMuOWF.js")
