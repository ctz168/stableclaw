...
import { r as theme, t as colorize } from "./theme-wBMZmJzz.js";
import { n as VERSION } from "./version-BNzJ37Re.js";
import { i as resolveAgentConfig } from "./agent-scope-rWWUivuC.js";
import { t as sameFileIdentity } from "./file-identity-DPm-6kp0.js";
import { a as logWarn } from "./logger-DdGvppaE.js";
import { c as loadConfig } from "./io-8kNEV_ou.js";
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-SlXI58bc.js";
import { B as resolveExecutableFromPathEnv, H as POSIX_SHELL_WRAPPERS, J as unwrapKnownShellMultiplexerInvocation, M as resolveApprovalAuditCandidatePath, P as resolveCommandResolutionFromArgv, T as resolvePlannedSegmentArgv, Y as POSIX_INLINE_COMMAND_FLAGS, Z as resolveInlineCommandMatch, et as unwrapKnownDispatchWrapperInvocation, tt as normalizeExecutableToken, y as analyzeArgvCommand } from "./validation-IqV6B-0y.js";
...
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-Bq55qi82.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-u00bwv47.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-NiQSNveu.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DPejcJWG.js";
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES } from "./message-channel-bEWdw4ul.js";
import { n as loadOrCreateDeviceIdentity } from "./device-identity-Doxo0HJx.js";
import { d as GatewayClient } from "./method-scopes-B6e_KuRU.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-6u4-kP5J.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-DkRlAuPR.js";
import { t as parsePort } from "./parse-port-BFmNhrtE.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DPrijqon.js";
import { d as getMachineDisplayName, n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-ZlT2PtoI.js";
import { A as saveExecApprovals, B as detectInterpreterInlineEvalArgv, C as requiresExecApproval, E as resolveExecApprovals, M as evaluateExecAllowlist, N as evaluateShellAllowlist, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, d as mergeExecApprovalsSocketDefaults, j as requestJsonlSocket, o as ensureExecApprovals, p as normalizeExecApprovals, s as hasDurableExecApproval, v as persistAllowAlwaysPatterns, y as readExecApprovalsSnapshot, z as describeInterpreterInlineEval } from "./exec-approvals-DAOB2dK4.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-By58XtjH.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-ycnRypMq.js";
import { s as resolveBrowserConfig } from "./browser-config-D_OlwMzh.js";
import { G as runBrowserProxyCommand } from "./browser-runtime-CQoD4tu1.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-B9Q5cWzd.js";
import { t as formatHelpExamples } from "./help-format-5ems77mC.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-ouznzcyn.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-Ch537Jyp.js";
...
function registerNodeCli(program) {
	...
	])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/node", "docs.stableclaw.ai/cli/node")}\n`);
