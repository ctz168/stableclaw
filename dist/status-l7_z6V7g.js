...
import "./status.summary-CLH76JUG.js";
...
function loadStatusScanModule() {
	statusScanModulePromise ??= import("./status.scan-D8pr740Y.js");
	return statusScanModulePromise;
}
function loadStatusScanFastJsonModule() {
	statusScanFastJsonModulePromise ??= import("./status.scan.fast-json-BH_D2ev3.js");
	return statusScanFastJsonModulePromise;
}
function loadStatusAllModule() {
	statusAllModulePromise ??= import("./status-all-8ctu5k4c.js");
	return statusAllModulePromise;
}
function loadStatusCommandTextRuntime() {
	statusCommandTextRuntimePromise ??= import("./status.command.text-runtime-Bx23yAAx.js");
	return statusCommandTextRuntimePromise;
}
function loadStatusNodeModeModule() {
	statusNodeModeModulePromise ??= import("./status.node-mode-DsNXnk96.js");
...
async function statusCommand(opts, runtime) {
	...
	runtime.log(theme.heading("StableClaw status"));
	runtime.log("");
	...
	runtime.log("");
	runtime.log("FAQ: https://docs.stableclaw.ai/faq");
	runtime.log("Troubleshooting: https://docs.stableclaw.ai/troubleshooting");
	runtime.log("");
