...
import { a as resolvePackageExtensionEntries } from "./manifest-f_gihArl.js";
import { a as safePathSegmentHashed, i as safeDirName, n as packageNameMatchesId, o as unscopedPackageName, r as resolveSafeInstallDir } from "./install-safe-path-Dk_ccRad.js";
import path from "node:path";
import fs from "node:fs/promises";
//#region src/plugins/install.ts
let pluginInstallRuntimePromise;
async function loadPluginInstallRuntime() {
	pluginInstallRuntimePromise ??= import("./install.runtime-Bk8Y4Jre.js");
	return pluginInstallRuntimePromise;
}
const MISSING_EXTENSIONS_ERROR = "package.json missing openclaw.extensions; update the plugin package to include openclaw.extensions (for example [\"./dist/index.js\"]). See https://docs.stableclaw.ai/help/troubleshooting#plugin-install-fails-with-missing-openclaw-extensions";
