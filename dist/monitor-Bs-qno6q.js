import { d as resolveThreadSessionKeys, u as resolveAgentIdFromSessionKey } from "./session-key-Do__tq1E.js";
...
import { a as buildExecApprovalPendingReplyPayload, c as getExecApprovalApproverDmNoticeText } from "./exec-approval-reply-U2GCj4yL.js";
...
import { c as resolveThreadBindingIdleTimeoutMsForChannel, d as resolveThreadBindingMaxAgeMsForChannel } from "./thread-bindings-policy-Br8s4hQ6.js";
...
import { i as resolveConfiguredAcpBindingRecord, t as ensureConfiguredAcpBindingReady } from "./persistent-bindings.lifecycle-BdieXmA4.js";
...
import { s as resolveMatrixAccountConfig } from "./config-paths-B5BXqXfz.js";
import { t as getMatrixRuntime } from "./runtime-BeTPYgLM.js";
import { i as resolveMatrixAccount, n as resolveConfiguredMatrixBotUserIds } from "./accounts-DS2fRXfi.js";
import "./runtime-api-DY4ft2XZ.js";
import { a as shouldHandleMatrixExecApprovalRequest, c as normalizeMatrixUserId, i as isMatrixExecApprovalClientEnabled, l as resolveMatrixAllowListMatch, r as matrixNativeApprovalAdapter, s as normalizeMatrixAllowList, t as resolveMatrixRoomConfig } from "./rooms-BzuVNDHH.js";
import { a as resolveMatrixTargetIdentity, t as isMatrixQualifiedUserId } from "./target-ids-DR8qn4Ki.js";
import { t as isBunRuntime } from "./runtime-DxHji2JP.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-Ctft1ZDl.js";
import { n as resolveMatrixStateFilePath } from "./storage-_gPZjPkP.js";
import { n as LogService } from "./logger-CaQNed0k.js";
import { i as resolveSharedMatrixClient, n as releaseSharedClientInstance } from "./shared-B5dl4Gtr.js";
import "./client-Dr5bRGDg.js";
import { t as resolveMatrixTargets } from "./resolve-targets-DdSZ7dTs.js";
import { a as sendMessageMatrix, c as sendSingleTextMessageMatrix, g as isPollStartType, h as isPollEventType, i as reactMatrixMessage, l as sendTypingMatrix, n as editMessageMatrix, p as formatPollAsText, r as prepareMatrixSingleText, s as sendReadReceiptMatrix, t as chunkMatrixText, v as parsePollStartContent } from "./send-CJCnyxeC.js";
import { c as MATRIX_REACTION_EVENT_TYPE, d as extractMatrixReactionAnnotation, i as repairMatrixDirectRooms, r as promoteMatrixDirectRoomCandidate } from "./direct-management-C7iOyDnF.js";
import { o as readJoinedMatrixMembers, r as isStrictDirectMembership, t as hasDirectMatrixMemberFlag } from "./direct-room-CYtk-u_o.js";
import { t as createMatrixThreadBindingManager } from "./thread-bindings-Csw9QnSN.js";
import { i as setActiveMatrixClient } from "./client-bootstrap-D4vWjsNs.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-DmbYyXZs.js";
import { c as formatMatrixMediaUnavailableText, d as resolveMatrixMessageBody, l as formatMatrixMessageText, n as editMatrixMessage, p as fetchMatrixPollSnapshot, t as deleteMatrixMessage, u as resolveMatrixMessageAttachment } from "./messages-2pYaHc6-.js";
import { t as isMatrixNotFoundError } from "./errors-DwsV6Nov.js";
import { t as createAsyncLock } from "./async-lock-BUF5tosx.js";
...
var MatrixExecApprovalHandler = class {
	constructor(opts, deps = {}) {
		...
		this.runtime = createChannelNativeApprovalRuntime({
			...
			buildPendingContent: ({ request, nowMs }) => buildPendingApprovalText({
				request,
				nowMs
			}),
...
async function loadMatrixDirectRoomDeps() {
	matrixDirectRoomDepsPromise ??= Promise.all([import("./direct-management-N8psUdwA.js"), import("./direct-room-CwEgvhVA.js")]).then(([directManagementModule, directRoomModule]) => ({
...
async function loadMatrixStartupMaintenanceDeps() {
	matrixStartupMaintenanceDepsPromise ??= Promise.all([
		import("./config-update-CZ7dCvRR.js"),
		import("./device-health-BMBtLpE-.js"),
		import("./profile-ekPgtW2e.js"),
		import("./legacy-crypto-restore-QXvcQR1m.js"),
		import("./startup-verification-C20zaYTY.js")
