...
import { a as listBundledPluginMetadata } from "./chat-meta-wVbKo1sw.js";
import { t as resolveStableNodePath } from "./stable-node-path-n7TARbHZ.js";
import { y as applyPathPrepend } from "./model-runtime-Bnss57nB.js";
import { i as parseAbsoluteTimeMs } from "./stagger-Cs-6sySM.js";
import { o as trimLogTail } from "./restart-sentinel-B3EigRIb.js";
import { i as autoMigrateLegacyMatrixState, n as hasPendingMatrixMigration, o as autoPrepareLegacyMatrixCrypto, r as maybeCreateMatrixMigrationSnapshot, t as hasActionableMatrixMigration } from "./matrix-migration-snapshot-sIK4GwxV.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-CA2ADQFJ.js";
import { n as compareSemverStrings, s as detectPackageManager$1 } from "./update-check-C4B4aSvJ.js";
import { a as isBetaTag, n as DEV_BRANCH, o as isStableTag, r as channelToNpmTag } from "./update-channels-Cqiboku6.js";
...
const PRIMARY_PACKAGE_NAME = "stableclaw";
const ALL_PACKAGE_NAMES = [PRIMARY_PACKAGE_NAME];
const GLOBAL_RENAME_PREFIX = ".";
const OPENCLAW_MAIN_PACKAGE_SPEC = "github:ctz168/stableclaw#main";
...
async function resolvePortableGitPathPrepend(env) {
	...
	const portableGitRoot = path.join(localAppData, "StableClaw", "deps", "portable-git");
	const candidates = [
...
async function runGatewayUpdate(opts = {}) {
	...
	if (gitRoot && pkgRoot && path.resolve(gitRoot) === path.resolve(pkgRoot)) {
		...
		const doctorEntry = path.join(gitRoot, "stableclaw.mjs");
		if (!await fs.stat(doctorEntry).then(() => true).catch(() => false)) {
			steps.push({
				name: "stableclaw doctor entry",
...
//#endregion
export { readPackageName as _, runGatewayUpdate as a, collectInstalledGlobalPackageErrors as c, detectGlobalInstallManagerForRoot as d, globalInstallArgs as f, normalizePackageTagInput as g, resolveGlobalPackageRoot as h, computePreviousRunAtMs as i, createGlobalInstallEnv as l, resolveGlobalInstallSpec as m, coerceFiniteScheduleNumber as n, canResolveRegistryVersionForPackageTarget as o, resolveExpectedInstalledVersionFromSpec as p, computeNextRunAtMs as r, cleanupGlobalRenameDirs as s, runStartupMatrixMigration as t, detectGlobalInstallManagerByPresence as u, readPackageVersion as v };
