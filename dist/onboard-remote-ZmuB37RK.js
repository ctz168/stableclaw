import { a as isSecureWebSocketUrl } from "./net-DjzoSxQo.js";
...
import { i as discoverGatewayBeacons, n as buildGatewayDiscoveryTarget, t as buildGatewayDiscoveryLabel } from "./gateway-discovery-targets-Iv8qDi-e.js";
...
async function promptRemoteGatewayConfig(cfg, prompter, options) {
	...
	if (!hasBonjourTool) await prompter.note(["Bonjour discovery requires dns-sd (macOS) or avahi-browse (Linux).", "Docs: https://docs.stableclaw.ai/gateway/discovery"].join("\n"), "Discovery");
	if (wantsDiscover) {
