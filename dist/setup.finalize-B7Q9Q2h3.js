import { i as restoreTerminalState } from "./runtime-kS8e4c6-.js";
import { m as pathExists, v as resolveUserPath } from "./utils-CN_F_3Qg.js";
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-D5P9nuJd.js";
import { n as resolveCliName } from "./cli-name-C3PA6Rhs.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-C9FOO4U_.js";
import { f as resolveControlUiLinks, g as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-BTKcMkph.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-2O78fADl.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-B2HBHMpF.js";
import { t as listConfiguredWebSearchProviders } from "./runtime-C6g97pFu.js";
...
import { t as runTui } from "./tui-BZ7oXNSm.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-Bg4dLrXb.js");
	...
	await prompter.note(["Back up your agent workspace.", "Docs: https://docs.stableclaw.ai/concepts/agent-workspace"].join("\n"), "Workspace backup");
	await prompter.note("Running agents on your computer is risky — harden your setup: https://docs.stableclaw.ai/security", "Security");
	...
	const { describeCodexNativeWebSearch } = await import("./codex-native-web-search-qhkBOvzq.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-C3bJkqG7.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-C3bJkqG7.js");
		const legacyDetected = configuredSearchProviders.find((e) => hasExistingKey(nextConfig, e.id) || hasKeyInEnv(e));
		if (legacyDetected) await prompter.note([`Web search is available via ${legacyDetected.label} (auto-detected).`, "Docs: https://docs.stableclaw.ai/tools/web"].join("\n"), "Web search");
