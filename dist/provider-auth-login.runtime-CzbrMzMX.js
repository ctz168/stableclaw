import { i as parseOAuthCallbackInput, n as exchangeChutesCodeForTokens, r as generateChutesPkce, t as CHUTES_AUTHORIZE_ENDPOINT } from "./chutes-oauth-Bh3BTMMG.js";
...
import { t as githubCopilotLoginCommand } from "./github-copilot-login-BIoVudRP.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-DZlN7NFS.js";
import { r as runOpenAIOAuthTlsPreflight, t as formatOpenAIOAuthTlsPreflightFix } from "./provider-openai-codex-oauth-tls-D96u1DiW.js";
...
async function loginOpenAICodexOAuth(params) {
	...
	try {
		...
		await prompter.note("Trouble with OAuth? See https://docs.stableclaw.ai/start/faq", "OAuth help");
		throw err;
	}
}
//#endregion
