...
import { c as moveSingleAccountChannelSectionToDefaultAccount, l as patchScopedAccountConfig } from "./setup-helpers-0yWIq2cW.js";
...
function loadProviderAuthInput() {
	providerAuthInputPromise ??= import("./provider-auth-ref-CJjlUplz.js");
...
async function promptSingleChannelSecretInput(params) {
	if (await resolveSecretInputModeForEnvSelection({
		...
		copy: {
			...
			plaintextHint: "Stores the credential directly in StableClaw config",
