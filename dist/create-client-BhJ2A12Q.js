import { s as resolveValidatedMatrixHomeserverUrl } from "./config-Ctft1ZDl.js";
import { i as writeStorageMeta, r as resolveMatrixStoragePaths, t as maybeMigrateLegacyStorage } from "./storage-_gPZjPkP.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-DSBktUvy.js"), import("./logging-DHUBfueq.js")]).then(([sdkModule, loggingModule]) => ({
