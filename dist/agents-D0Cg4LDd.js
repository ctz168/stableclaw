...
import { d as resolveAuthStorePath, n as ensureAuthProfileStore } from "./store-DQJZr0Yf.js";
import "./auth-profiles-BnMrVe53.js";
import { c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID, t as DEFAULT_AGENT_ID } from "./session-key-Do__tq1E.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, n as listAgentEntries, p as resolveAgentWorkspaceDir } from "./agent-scope-rWWUivuC.js";
import "./workspace-D5P9nuJd.js";
...
import { r as ensureWorkspaceAndSessions, s as moveToTrash } from "./onboard-helpers-BTKcMkph.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-COHnQbWX.js";
import { i as listRouteBindings, t as isRouteBinding } from "./bindings-AuReyzvX.js";
import { t as WizardCancelledError } from "./prompts-B3b6Rijh.js";
import { n as logConfigUpdated } from "./logging-B6ynZ77b.js";
import { r as parseIdentityMarkdown, t as identityHasValues } from "./identity-file-BAJFyXVV.js";
import { t as createClackPrompter } from "./clack-prompter-ByJgKHdE.js";
import { a as describeBinding, i as buildChannelBindings, n as requireValidConfigSnapshot, o as parseBindingSpecs, r as applyAgentBindings, s as removeAgentBindings, t as requireValidConfigFileSnapshot$1 } from "./config-validation-DEhPxgGH.js";
import { i as loadAgentIdentity, n as buildAgentSummaries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-D7lFNFDm.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-D-9gW3Ad.js";
import { n as applyAuthChoice, t as warnIfModelConfigLooksOff } from "./auth-choice-brLIkhhO.js";
import { r as setupChannels } from "./onboard-channels-BkU8zmv7.js";
...
async function agentsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	try {
		...
		} else await prompter.note(["Routing unchanged. Add bindings when you're ready.", "Docs: https://docs.stableclaw.ai/concepts/multi-agent"].join("\n"), "Routing");
		await replaceConfigFile({
			nextConfig,
			...baseHash !== void 0 ? { baseHash } : {}
		});
