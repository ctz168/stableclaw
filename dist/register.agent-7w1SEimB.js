...
import { r as listAgentIds } from "./agent-scope-rWWUivuC.js";
...
import { _ as GATEWAY_CLIENT_NAMES, d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES } from "./message-channel-bEWdw4ul.js";
import { c as randomIdempotencyKey, r as callGateway } from "./call-DRbdwIRZ.js";
...
import { r as resolveSessionKeyForRequest, t as agentCommand } from "./agent-command-CikUocCw.js";
import { n as runCommandWithRuntime } from "./cli-utils-qgKJn7xy.js";
import { t as formatHelpExamples } from "./help-format-5ems77mC.js";
import "./agent-DczUASA4.js";
import { t as collectOption } from "./helpers-Bob1LTom.js";
import { a as agentsBindCommand, i as agentsAddCommand, n as agentsSetIdentityCommand, o as agentsBindingsCommand, r as agentsDeleteCommand, s as agentsUnbindCommand, t as agentsListCommand } from "./agents-D0Cg4LDd.js";
...
${formatHelpExamples([
		["stableclaw agent --to +15555550123 --message \"status update\"", "Start a new session."],
		["stableclaw agent --agent ops --message \"Summarize logs\"", "Use a specific agent."],
		["stableclaw agent --session-id 1234 --message \"Summarize inbox\" --thinking medium", "Target a session with explicit thinking level."],
		["stableclaw agent --to +15555550123 --message \"Trace logs\" --verbose on --json", "Enable verbose logging and JSON output."],
		["stableclaw agent --to +15555550123 --message \"Summon reply\" --deliver", "Deliver reply."],
		["stableclaw agent --agent ops --message \"Generate report\" --deliver --reply-channel slack --reply-to \"#reports\"", "Send reply to a different channel/target."]
	])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.stableclaw.ai/cli/agent")}`).action(async (opts) => {
...
${theme.heading("Examples:")}
${formatHelpExamples([
		["stableclaw agents set-identity --agent main --name \"StableClaw\" --emoji \"🦞\"", "Set name + emoji."],
		["stableclaw agents set-identity --agent main --avatar avatars/stableclaw.png", "Set avatar path."],
